...
// Type: DocumentFormat.OpenXml.Internal.SchemaValidation.CompositeParticle
    ...
    internal override IParticleValidator ParticleValidator
    {
      get
      {
        if (this._particleValidator == null)
          this._particleValidator = (IParticleValidator) DocumentFormat.OpenXml.Internal.SchemaValidation.ParticleValidator.CreateParticleValidator((ParticleConstraint) this);
