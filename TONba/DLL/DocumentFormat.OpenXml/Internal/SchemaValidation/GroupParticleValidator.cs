...
// Type: DocumentFormat.OpenXml.Internal.SchemaValidation.GroupParticleValidator
...
namespace DocumentFormat.OpenXml.Internal.SchemaValidation
{
  internal class GroupParticleValidator : CompositeParticleValidator
  {
    ...
    {
      this.ParticleConstraint.ChildrenParticles[0].ParticleValidator.TryMatch(particleMatchInfo, validationContext);
    }
  }
}
