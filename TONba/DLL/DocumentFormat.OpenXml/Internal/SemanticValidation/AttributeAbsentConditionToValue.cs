...
// Type: DocumentFormat.OpenXml.Internal.SemanticValidation.AttributeAbsentConditionToValue
      ...
      foreach (string str1 in this._values)
      {
        if (SemanticConstraint.AttributeValueEquals(attribute, str1, false))
        {
          ...
          return new ValidationErrorInfo()
          {
            ...
            Description = string.Format((IFormatProvider) CultureInfo.CurrentUICulture, ValidationResources.Sem_AttributeAbsentConditionToValue, (object) SemanticConstraint.GetAttributeQualifiedName(context.Element, this._absentAttribute), (object) SemanticConstraint.GetAttributeQualifiedName(context.Element, this._conditionAttribute), (object) str2)
          };
        }
      }
      return (ValidationErrorInfo) null;
