...
// Type: DocumentFormat.OpenXml.Drawing.PresetShadow
...
namespace DocumentFormat.OpenXml.Drawing
{
  ...
  public class PresetShadow : OpenXmlCompositeElement
  {
    ...
    public EnumValue<PresetShadowValues> Preset
    {
      get
      {
        return (EnumValue<PresetShadowValues>) this.Attributes[0];
      }
      set
      {
    ...
    internal override OpenXmlSimpleType AttributeFactory(byte namespaceId, string name)
    {
      if ((int) namespaceId == 0 && "prst" == name)
        return (OpenXmlSimpleType) new EnumValue<PresetShadowValues>();
    ...
    {
      return (OpenXmlElement) this.CloneImp<PresetShadow>(deep);
    }
  }
}
