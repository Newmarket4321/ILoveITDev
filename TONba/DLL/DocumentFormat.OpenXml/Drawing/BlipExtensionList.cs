...
// Type: DocumentFormat.OpenXml.Drawing.BlipExtensionList
...
namespace DocumentFormat.OpenXml.Drawing
{
  ...
  public class BlipExtensionList : OpenXmlCompositeElement
  {
    ...
    internal override OpenXmlElement ElementFactory(byte namespaceId, string name)
    {
      if (10 == (int) namespaceId && "ext" == name)
        return (OpenXmlElement) new BlipExtension();
      return (OpenXmlElement) null;
    }

    public override OpenXmlElement CloneNode(bool deep)
    {
      return (OpenXmlElement) this.CloneImp<BlipExtensionList>(deep);
    }
  }
}
