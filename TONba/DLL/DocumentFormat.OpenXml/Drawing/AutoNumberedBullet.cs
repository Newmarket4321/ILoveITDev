...
// Type: DocumentFormat.OpenXml.Drawing.AutoNumberedBullet
...
namespace DocumentFormat.OpenXml.Drawing
{
  ...
  public class AutoNumberedBullet : OpenXmlLeafElement
  {
    ...
    public EnumValue<TextAutoNumberSchemeValues> Type
    {
      get
      {
        return (EnumValue<TextAutoNumberSchemeValues>) this.Attributes[0];
      }
      set
      {
    ...
    internal override OpenXmlSimpleType AttributeFactory(byte namespaceId, string name)
    {
      if ((int) namespaceId == 0 && "type" == name)
        return (OpenXmlSimpleType) new EnumValue<TextAutoNumberSchemeValues>();
      if ((int) namespaceId == 0 && "startAt" == name)
    ...
    {
      return (OpenXmlElement) this.CloneImp<AutoNumberedBullet>(deep);
    }
  }
}
