...
// Type: DocumentFormat.OpenXml.Drawing.Diagrams.Parameter
...
namespace DocumentFormat.OpenXml.Drawing.Diagrams
{
  ...
  public class Parameter : OpenXmlLeafElement
  {
    ...
    public EnumValue<ParameterIdValues> Type
    {
      get
      {
        return (EnumValue<ParameterIdValues>) this.Attributes[0];
      }
      set
      {
    ...
    internal override OpenXmlSimpleType AttributeFactory(byte namespaceId, string name)
    {
      if ((int) namespaceId == 0 && "type" == name)
        return (OpenXmlSimpleType) new EnumValue<ParameterIdValues>();
