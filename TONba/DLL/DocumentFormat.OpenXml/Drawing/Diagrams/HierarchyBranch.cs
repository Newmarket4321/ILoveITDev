...
namespace DocumentFormat.OpenXml.Drawing.Diagrams
{
  ...
  public class HierarchyBranch : OpenXmlLeafElement
  {
    ...
    public EnumValue<HierarchyBranchStyleValues> Val
    {
      get
      {
        return (EnumValue<HierarchyBranchStyleValues>) this.Attributes[0];
      }
      set
      {
    ...
    internal override OpenXmlSimpleType AttributeFactory(byte namespaceId, string name)
    {
      if ((int) namespaceId == 0 && "val" == name)
        return (OpenXmlSimpleType) new EnumValue<HierarchyBranchStyleValues>();
      return base.AttributeFactory(namespaceId, name);
    }

    public override OpenXmlElement CloneNode(bool deep)
    {
      return (OpenXmlElement) this.CloneImp<HierarchyBranch>(deep);
    }
  }
}
