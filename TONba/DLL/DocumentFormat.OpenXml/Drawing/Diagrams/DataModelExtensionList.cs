...
// Type: DocumentFormat.OpenXml.Drawing.Diagrams.DataModelExtensionList
...
namespace DocumentFormat.OpenXml.Drawing.Diagrams
{
  ...
  public class DataModelExtensionList : OpenXmlCompositeElement
  {
    ...
    internal override OpenXmlElement ElementFactory(byte namespaceId, string name)
    {
      if (10 == (int) namespaceId && "ext" == name)
        return (OpenXmlElement) new DataModelExtension();
      return (OpenXmlElement) null;
    }

    public override OpenXmlElement CloneNode(bool deep)
    {
      return (OpenXmlElement) this.CloneImp<DataModelExtensionList>(deep);
    }
  }
}
