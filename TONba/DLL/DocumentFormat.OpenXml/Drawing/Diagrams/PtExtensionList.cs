...
// Type: DocumentFormat.OpenXml.Drawing.Diagrams.PtExtensionList
...
namespace DocumentFormat.OpenXml.Drawing.Diagrams
{
  ...
  public class PtExtensionList : OpenXmlCompositeElement
  {
    ...
    internal override OpenXmlElement ElementFactory(byte namespaceId, string name)
    {
      if (10 == (int) namespaceId && "ext" == name)
        return (OpenXmlElement) new PtExtension();
      return (OpenXmlElement) null;
    }

    public override OpenXmlElement CloneNode(bool deep)
    {
      return (OpenXmlElement) this.CloneImp<PtExtensionList>(deep);
    }
  }
}
