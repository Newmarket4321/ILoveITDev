...
// Type: DocumentFormat.OpenXml.Drawing.GvmlGroupShapeExtensionList
...
namespace DocumentFormat.OpenXml.Drawing
{
  ...
  public class GvmlGroupShapeExtensionList : OpenXmlCompositeElement
  {
    ...
    internal override OpenXmlElement ElementFactory(byte namespaceId, string name)
    {
      if (10 == (int) namespaceId && "ext" == name)
        return (OpenXmlElement) new GvmlGroupShapeExtension();
      return (OpenXmlElement) null;
    }

    public override OpenXmlElement CloneNode(bool deep)
    {
      return (OpenXmlElement) this.CloneImp<GvmlGroupShapeExtensionList>(deep);
    }
  }
}
