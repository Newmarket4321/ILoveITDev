...
// Type: DocumentFormat.OpenXml.Drawing.ConnectionSiteList
...
namespace DocumentFormat.OpenXml.Drawing
{
  ...
  public class ConnectionSiteList : OpenXmlCompositeElement
  {
    ...
    {
      if (10 == (int) namespaceId && "cxn" == name)
        return (OpenXmlElement) new ConnectionSite();
      return (OpenXmlElement) null;
    }

    public override OpenXmlElement CloneNode(bool deep)
    {
      return (OpenXmlElement) this.CloneImp<ConnectionSiteList>(deep);
    }
  }
}
