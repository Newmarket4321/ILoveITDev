...
namespace DocumentFormat.OpenXml.Drawing
{
  ...
  public class PresetColor : OpenXmlCompositeElement
  {
    ...
    public EnumValue<PresetColorValues> Val
    {
      get
      {
        return (EnumValue<PresetColorValues>) this.Attributes[0];
      }
      set
      {
    ...
    internal override OpenXmlSimpleType AttributeFactory(byte namespaceId, string name)
    {
      if ((int) namespaceId == 0 && "val" == name)
        return (OpenXmlSimpleType) new EnumValue<PresetColorValues>();
      return base.AttributeFactory(namespaceId, name);
    }

    public override OpenXmlElement CloneNode(bool deep)
    {
      return (OpenXmlElement) this.CloneImp<PresetColor>(deep);
    }
  }
}
