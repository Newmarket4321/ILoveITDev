...
// Type: DocumentFormat.OpenXml.Drawing.PictureLocks
...
namespace DocumentFormat.OpenXml.Drawing
{
  ...
  public class PictureLocks : OpenXmlCompositeElement
  {
    ...
    internal override OpenXmlSimpleType AttributeFactory(byte namespaceId, string name)
    {
      ...
      if ((int) namespaceId == 0 && "noChangeShapeType" == name)
        return (OpenXmlSimpleType) new BooleanValue();
      if ((int) namespaceId == 0 && "noCrop" == name)
        return (OpenXmlSimpleType) new BooleanValue();
    ...
    {
      return (OpenXmlElement) this.CloneImp<PictureLocks>(deep);
    }
  }
}
