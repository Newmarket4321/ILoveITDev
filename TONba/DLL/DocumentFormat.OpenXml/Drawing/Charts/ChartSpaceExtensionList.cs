...
// Type: DocumentFormat.OpenXml.Drawing.Charts.ChartSpaceExtensionList
...
namespace DocumentFormat.OpenXml.Drawing.Charts
{
  ...
  public class ChartSpaceExtensionList : OpenXmlCompositeElement
  {
    ...
    internal override OpenXmlElement ElementFactory(byte namespaceId, string name)
    {
      if (11 == (int) namespaceId && "ext" == name)
        return (OpenXmlElement) new ChartSpaceExtension();
      return (OpenXmlElement) null;
    }

    public override OpenXmlElement CloneNode(bool deep)
    {
      return (OpenXmlElement) this.CloneImp<ChartSpaceExtensionList>(deep);
    }
  }
}
