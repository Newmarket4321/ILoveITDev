...
// Type: DocumentFormat.OpenXml.Drawing.Charts.PieSerExtension
...
namespace DocumentFormat.OpenXml.Drawing.Charts
{
  ...
  public class PieSerExtension : OpenXmlCompositeElement
  {
    ...
    internal override string[] AttributeTagNames
    {
      get
      {
        return PieSerExtension.attributeTagNames;
      }
    }
    ...
    internal override byte[] AttributeNamespaceIds
    {
      get
      {
        return PieSerExtension.attributeNamespaceIds;
      }
    }
    ...
    public PieSerExtension()
    {
    }

    public PieSerExtension(IEnumerable<OpenXmlElement> childElements)
      : base(childElements)
    {
    }

    public PieSerExtension(params OpenXmlElement[] childElements)
      : base(childElements)
    {
    }
    ...
    {
      return (OpenXmlElement) this.CloneImp<PieSerExtension>(deep);
    }
  }
}
