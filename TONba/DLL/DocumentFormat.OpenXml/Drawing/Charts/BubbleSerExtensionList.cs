...
// Type: DocumentFormat.OpenXml.Drawing.Charts.BubbleSerExtensionList
...
namespace DocumentFormat.OpenXml.Drawing.Charts
{
  ...
  public class BubbleSerExtensionList : OpenXmlCompositeElement
  {
    ...
    internal override OpenXmlElement ElementFactory(byte namespaceId, string name)
    {
      if (11 == (int) namespaceId && "ext" == name)
        return (OpenXmlElement) new BubbleSerExtension();
      return (OpenXmlElement) null;
    }

    public override OpenXmlElement CloneNode(bool deep)
    {
      return (OpenXmlElement) this.CloneImp<BubbleSerExtensionList>(deep);
    }
  }
}
