...
// Type: DocumentFormat.OpenXml.Drawing.Charts.CustomSplit
...
namespace DocumentFormat.OpenXml.Drawing.Charts
{
  ...
  public class CustomSplit : OpenXmlCompositeElement
  {
    ...
    {
      if (11 == (int) namespaceId && "secondPiePt" == name)
        return (OpenXmlElement) new SecondPiePoint();
      return (OpenXmlElement) null;
    }

    public override OpenXmlElement CloneNode(bool deep)
    {
      return (OpenXmlElement) this.CloneImp<CustomSplit>(deep);
    }
  }
}
