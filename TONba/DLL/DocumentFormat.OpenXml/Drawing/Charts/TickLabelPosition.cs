...
namespace DocumentFormat.OpenXml.Drawing.Charts
{
  ...
  public class TickLabelPosition : OpenXmlLeafElement
  {
    ...
    public EnumValue<TickLabelPositionValues> Val
    {
      get
      {
        return (EnumValue<TickLabelPositionValues>) this.Attributes[0];
      }
      set
      {
    ...
    internal override OpenXmlSimpleType AttributeFactory(byte namespaceId, string name)
    {
      if ((int) namespaceId == 0 && "val" == name)
        return (OpenXmlSimpleType) new EnumValue<TickLabelPositionValues>();
      return base.AttributeFactory(namespaceId, name);
    }

    public override OpenXmlElement CloneNode(bool deep)
    {
      return (OpenXmlElement) this.CloneImp<TickLabelPosition>(deep);
    }
  }
}
