...
// Type: DocumentFormat.OpenXml.Drawing.Charts.CategoryAxis
...
namespace DocumentFormat.OpenXml.Drawing.Charts
{
  ...
  public class CategoryAxis : OpenXmlCompositeElement
  {
    ...
    internal override OpenXmlElement ElementFactory(byte namespaceId, string name)
    {
      ...
      if (11 == (int) namespaceId && "lblAlgn" == name)
        return (OpenXmlElement) new LabelAlignment();
      ...
      if (11 == (int) namespaceId && "noMultiLvlLbl" == name)
        return (OpenXmlElement) new NoMultiLevelLabels();
      if (11 == (int) namespaceId && "extLst" == name)
        return (OpenXmlElement) new CatAxExtensionList();
