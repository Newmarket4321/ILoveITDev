...
namespace DocumentFormat.OpenXml.Drawing.Charts
{
  ...
  public class ErrorDirection : OpenXmlLeafElement
  {
    ...
    public EnumValue<ErrorBarDirectionValues> Val
    {
      get
      {
        return (EnumValue<ErrorBarDirectionValues>) this.Attributes[0];
      }
      set
      {
    ...
    internal override OpenXmlSimpleType AttributeFactory(byte namespaceId, string name)
    {
      if ((int) namespaceId == 0 && "val" == name)
        return (OpenXmlSimpleType) new EnumValue<ErrorBarDirectionValues>();
      return base.AttributeFactory(namespaceId, name);
    }

    public override OpenXmlElement CloneNode(bool deep)
    {
      return (OpenXmlElement) this.CloneImp<ErrorDirection>(deep);
    }
  }
}
