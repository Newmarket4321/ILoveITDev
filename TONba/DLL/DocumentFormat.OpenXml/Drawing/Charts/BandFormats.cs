...
// Type: DocumentFormat.OpenXml.Drawing.Charts.BandFormats
...
namespace DocumentFormat.OpenXml.Drawing.Charts
{
  ...
  public class BandFormats : OpenXmlCompositeElement
  {
    ...
    {
      if (11 == (int) namespaceId && "bandFmt" == name)
        return (OpenXmlElement) new BandFormat();
      return (OpenXmlElement) null;
    }

    public override OpenXmlElement CloneNode(bool deep)
    {
      return (OpenXmlElement) this.CloneImp<BandFormats>(deep);
    }
  }
}
