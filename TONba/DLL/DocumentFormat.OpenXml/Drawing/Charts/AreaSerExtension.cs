...
// Type: DocumentFormat.OpenXml.Drawing.Charts.AreaSerExtension
...
namespace DocumentFormat.OpenXml.Drawing.Charts
{
  ...
  public class AreaSerExtension : OpenXmlCompositeElement
  {
    ...
    internal override string[] AttributeTagNames
    {
      get
      {
        return AreaSerExtension.attributeTagNames;
      }
    }
    ...
    internal override byte[] AttributeNamespaceIds
    {
      get
      {
        return AreaSerExtension.attributeNamespaceIds;
      }
    }
    ...
    public AreaSerExtension(IEnumerable<OpenXmlElement> childElements)
      : base(childElements)
    {
    }

    public AreaSerExtension(params OpenXmlElement[] childElements)
      : base(childElements)
    {
    }
    ...
    {
      return (OpenXmlElement) this.CloneImp<AreaSerExtension>(deep);
    }
  }
}
