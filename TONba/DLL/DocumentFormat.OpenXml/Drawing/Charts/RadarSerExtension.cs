...
// Type: DocumentFormat.OpenXml.Drawing.Charts.RadarSerExtension
...
namespace DocumentFormat.OpenXml.Drawing.Charts
{
  ...
  public class RadarSerExtension : OpenXmlCompositeElement
  {
    ...
    internal override string[] AttributeTagNames
    {
      get
      {
        return RadarSerExtension.attributeTagNames;
      }
    }
    ...
    internal override byte[] AttributeNamespaceIds
    {
      get
      {
        return RadarSerExtension.attributeNamespaceIds;
      }
    }
    ...
    public RadarSerExtension()
    {
    }

    public RadarSerExtension(IEnumerable<OpenXmlElement> childElements)
      : base(childElements)
    {
    }

    public RadarSerExtension(params OpenXmlElement[] childElements)
      : base(childElements)
    {
    }
    ...
    {
      return (OpenXmlElement) this.CloneImp<RadarSerExtension>(deep);
    }
  }
}
