...
namespace DocumentFormat.OpenXml.Drawing.Charts
{
  ...
  public class ErrorBarValueType : OpenXmlLeafElement
  {
    ...
    public EnumValue<ErrorValues> Val
    {
      get
      {
        return (EnumValue<ErrorValues>) this.Attributes[0];
      }
      set
      {
    ...
    internal override OpenXmlSimpleType AttributeFactory(byte namespaceId, string name)
    {
      if ((int) namespaceId == 0 && "val" == name)
        return (OpenXmlSimpleType) new EnumValue<ErrorValues>();
      return base.AttributeFactory(namespaceId, name);
    }

    public override OpenXmlElement CloneNode(bool deep)
    {
      return (OpenXmlElement) this.CloneImp<ErrorBarValueType>(deep);
    }
  }
}
