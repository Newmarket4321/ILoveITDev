...
// Type: DocumentFormat.OpenXml.Drawing.Charts.MultiLvlStrRefExtension
...
namespace DocumentFormat.OpenXml.Drawing.Charts
{
  ...
  public class MultiLvlStrRefExtension : OpenXmlCompositeElement
  {
    ...
    internal override string[] AttributeTagNames
    {
      get
      {
        return MultiLvlStrRefExtension.attributeTagNames;
      }
    }
    ...
    internal override byte[] AttributeNamespaceIds
    {
      get
      {
        return MultiLvlStrRefExtension.attributeNamespaceIds;
      }
    }
    ...
    public MultiLvlStrRefExtension(IEnumerable<OpenXmlElement> childElements)
      : base(childElements)
    {
    }

    public MultiLvlStrRefExtension(params OpenXmlElement[] childElements)
      : base(childElements)
    {
    }
    ...
    {
      return (OpenXmlElement) this.CloneImp<MultiLvlStrRefExtension>(deep);
    }
  }
}
