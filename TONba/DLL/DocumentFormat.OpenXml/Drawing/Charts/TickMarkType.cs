...
// Type: DocumentFormat.OpenXml.Drawing.Charts.TickMarkType
...
namespace DocumentFormat.OpenXml.Drawing.Charts
{
  ...
  public abstract class TickMarkType : OpenXmlLeafElement
  {
    ...
    public EnumValue<TickMarkValues> Val
    {
      get
      {
        return (EnumValue<TickMarkValues>) this.Attributes[0];
      }
      set
      {
    ...
    internal override OpenXmlSimpleType AttributeFactory(byte namespaceId, string name)
    {
      if ((int) namespaceId == 0 && "val" == name)
        return (OpenXmlSimpleType) new EnumValue<TickMarkValues>();
