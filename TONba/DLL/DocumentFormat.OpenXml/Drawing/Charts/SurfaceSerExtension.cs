...
// Type: DocumentFormat.OpenXml.Drawing.Charts.SurfaceSerExtension
...
namespace DocumentFormat.OpenXml.Drawing.Charts
{
  ...
  public class SurfaceSerExtension : OpenXmlCompositeElement
  {
    ...
    internal override string[] AttributeTagNames
    {
      get
      {
        return SurfaceSerExtension.attributeTagNames;
      }
    }
    ...
    internal override byte[] AttributeNamespaceIds
    {
      get
      {
        return SurfaceSerExtension.attributeNamespaceIds;
      }
    }
    ...
    public SurfaceSerExtension(IEnumerable<OpenXmlElement> childElements)
      : base(childElements)
    {
    }

    public SurfaceSerExtension(params OpenXmlElement[] childElements)
      : base(childElements)
    {
    }
    ...
    {
      return (OpenXmlElement) this.CloneImp<SurfaceSerExtension>(deep);
    }
  }
}
