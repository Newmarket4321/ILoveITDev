...
namespace DocumentFormat.OpenXml.Drawing.Charts
{
  ...
  public class LegendPosition : OpenXmlLeafElement
  {
    ...
    public EnumValue<LegendPositionValues> Val
    {
      get
      {
        return (EnumValue<LegendPositionValues>) this.Attributes[0];
      }
      set
      {
    ...
    internal override OpenXmlSimpleType AttributeFactory(byte namespaceId, string name)
    {
      if ((int) namespaceId == 0 && "val" == name)
        return (OpenXmlSimpleType) new EnumValue<LegendPositionValues>();
      return base.AttributeFactory(namespaceId, name);
    }

    public override OpenXmlElement CloneNode(bool deep)
    {
      return (OpenXmlElement) this.CloneImp<LegendPosition>(deep);
    }
  }
}
