...
// Type: DocumentFormat.OpenXml.Drawing.Charts.DLblExtension
...
namespace DocumentFormat.OpenXml.Drawing.Charts
{
  ...
  public class DLblExtension : OpenXmlCompositeElement
  {
    ...
    internal override string[] AttributeTagNames
    {
      get
      {
        return DLblExtension.attributeTagNames;
      }
    }
    ...
    internal override byte[] AttributeNamespaceIds
    {
      get
      {
        return DLblExtension.attributeNamespaceIds;
      }
    }
    ...
    public DLblExtension()
    {
    }

    public DLblExtension(IEnumerable<OpenXmlElement> childElements)
      : base(childElements)
    {
    }

    public DLblExtension(params OpenXmlElement[] childElements)
      : base(childElements)
    {
    }
    ...
    {
      return (OpenXmlElement) this.CloneImp<DLblExtension>(deep);
    }
  }
}
