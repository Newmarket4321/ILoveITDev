...
// Type: DocumentFormat.OpenXml.Drawing.Spreadsheet.NonVisualConnectionShapeProperties
...
namespace DocumentFormat.OpenXml.Drawing.Spreadsheet
{
  ...
  public class NonVisualConnectionShapeProperties : OpenXmlCompositeElement
  {
    ...
    {
      if (18 == (int) namespaceId && "cNvPr" == name)
        return (OpenXmlElement) new NonVisualDrawingProperties();
      if (18 == (int) namespaceId && "cNvCxnSpPr" == name)
