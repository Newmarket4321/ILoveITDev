...
// Type: DocumentFormat.OpenXml.Drawing.NonVisualPicturePropertiesExtensionList
...
namespace DocumentFormat.OpenXml.Drawing
{
  ...
  public class NonVisualPicturePropertiesExtensionList : OpenXmlCompositeElement
  {
    ...
    internal override OpenXmlElement ElementFactory(byte namespaceId, string name)
    {
      if (10 == (int) namespaceId && "ext" == name)
        return (OpenXmlElement) new NonVisualPicturePropertiesExtension();
      return (OpenXmlElement) null;
    }

    public override OpenXmlElement CloneNode(bool deep)
    {
      return (OpenXmlElement) this.CloneImp<NonVisualPicturePropertiesExtensionList>(deep);
    }
  }
}
