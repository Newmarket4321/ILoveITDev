...
// Type: DocumentFormat.OpenXml.Office2010.CustomUI.BackstageComboBox
...
namespace DocumentFormat.OpenXml.Office2010.CustomUI
{
  ...
  [ChildElementInfo(typeof (ItemBackstageItem), FileFormatVersions.Office2010 | FileFormatVersions.Office2013)]
  [GeneratedCode("DomGen", "2.0")]
  public class BackstageComboBox : OpenXmlCompositeElement
  {
    ...
    internal override OpenXmlElement ElementFactory(byte namespaceId, string name)
    {
      if (57 == (int) namespaceId && "item" == name)
        return (OpenXmlElement) new ItemBackstageItem();
    ...
    internal override OpenXmlSimpleType AttributeFactory(byte namespaceId, string name)
    {
      ...
      if ((int) namespaceId == 0 && "getKeytip" == name)
        return (OpenXmlSimpleType) new StringValue();
      if ((int) namespaceId == 0 && "getText" == name)
        return (OpenXmlSimpleType) new StringValue();
      if ((int) namespaceId == 0 && "onChange" == name)
        return (OpenXmlSimpleType) new StringValue();
    ...
    {
      return (OpenXmlElement) this.CloneImp<BackstageComboBox>(deep);
    }
  }
}
