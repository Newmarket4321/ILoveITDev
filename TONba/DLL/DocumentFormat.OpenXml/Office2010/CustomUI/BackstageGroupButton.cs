...
// Type: DocumentFormat.OpenXml.Office2010.CustomUI.BackstageGroupButton
...
namespace DocumentFormat.OpenXml.Office2010.CustomUI
{
  ...
  public class BackstageGroupButton : OpenXmlLeafElement
  {
    ...
    public EnumValue<Style2Values> Style
    {
      get
      {
        return (EnumValue<Style2Values>) this.Attributes[1];
      }
      set
      {
    ...
    internal override OpenXmlSimpleType AttributeFactory(byte namespaceId, string name)
    {
      ...
      if ((int) namespaceId == 0 && "style" == name)
        return (OpenXmlSimpleType) new EnumValue<Style2Values>();
    ...
    {
      return (OpenXmlElement) this.CloneImp<BackstageGroupButton>(deep);
    }
  }
}
