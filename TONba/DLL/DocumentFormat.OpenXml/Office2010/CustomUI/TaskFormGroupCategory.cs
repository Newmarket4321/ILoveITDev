...
// Type: DocumentFormat.OpenXml.Office2010.CustomUI.TaskFormGroupCategory
...
namespace DocumentFormat.OpenXml.Office2010.CustomUI
{
  ...
  [ChildElementInfo(typeof (TaskFormGroupTask), FileFormatVersions.Office2010 | FileFormatVersions.Office2013)]
  [GeneratedCode("DomGen", "2.0")]
  public class TaskFormGroupCategory : OpenXmlCompositeElement
  {
    ...
    internal override OpenXmlElement ElementFactory(byte namespaceId, string name)
    {
      if (57 == (int) namespaceId && "task" == name)
        return (OpenXmlElement) new TaskFormGroupTask();
    ...
    {
      return (OpenXmlElement) this.CloneImp<TaskFormGroupCategory>(deep);
    }
  }
}
