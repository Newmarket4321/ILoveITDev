...
// Type: DocumentFormat.OpenXml.Office2010.CustomUI.VisibleToggleButton
...
namespace DocumentFormat.OpenXml.Office2010.CustomUI
{
  ...
  public class VisibleToggleButton : OpenXmlLeafElement
  {
    private static string[] attributeTagNames = new string[29]
    {
      "getPressed",
      "onAction",
      "enabled",
    ...
    private static byte[] attributeNamespaceIds = new byte[29];
    ...
    {
      return (OpenXmlElement) this.CloneImp<VisibleToggleButton>(deep);
    }
  }
}
