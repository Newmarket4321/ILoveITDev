...
// Type: DocumentFormat.OpenXml.Office2010.CustomUI.DynamicMenuRegular
...
namespace DocumentFormat.OpenXml.Office2010.CustomUI
{
  ...
  public class DynamicMenuRegular : OpenXmlLeafElement
  {
    ...
    internal override OpenXmlSimpleType AttributeFactory(byte namespaceId, string name)
    {
      ...
      if ((int) namespaceId == 0 && "idMso" == name)
        return (OpenXmlSimpleType) new StringValue();
      if ((int) namespaceId == 0 && "getContent" == name)
        return (OpenXmlSimpleType) new StringValue();
    ...
    {
      return (OpenXmlElement) this.CloneImp<DynamicMenuRegular>(deep);
    }
  }
}
