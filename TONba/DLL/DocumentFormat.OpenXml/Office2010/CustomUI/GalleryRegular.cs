...
// Type: DocumentFormat.OpenXml.Office2010.CustomUI.GalleryRegular
...
namespace DocumentFormat.OpenXml.Office2010.CustomUI
{
  ...
  {
    private static string[] attributeTagNames = new string[49]
    {
      "description",
      "getDescription",
    ...
    public EnumValue<GalleryShowInRibbonValues> ShowInRibbon
    {
      get
      {
        return (EnumValue<GalleryShowInRibbonValues>) this.Attributes[10];
      }
      set
      {
    ...
    {
      return (OpenXmlElement) this.CloneImp<GalleryRegular>(deep);
    }
  }
}
