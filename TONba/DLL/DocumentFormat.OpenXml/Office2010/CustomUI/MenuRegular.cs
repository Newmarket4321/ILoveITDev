...
// Type: DocumentFormat.OpenXml.Office2010.CustomUI.MenuRegular
...
namespace DocumentFormat.OpenXml.Office2010.CustomUI
{
  ...
  public class MenuRegular : OpenXmlCompositeElement
  {
    ...
    public EnumValue<ItemSizeValues> ItemSize
    {
      get
      {
        return (EnumValue<ItemSizeValues>) this.Attributes[0];
      }
      set
      {
    ...
    {
      return (OpenXmlElement) this.CloneImp<MenuRegular>(deep);
    }
  }
}
