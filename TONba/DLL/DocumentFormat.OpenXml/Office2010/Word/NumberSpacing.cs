...
// Type: DocumentFormat.OpenXml.Office2010.Word.NumberSpacing
...
namespace DocumentFormat.OpenXml.Office2010.Word
{
  ...
  public class NumberSpacing : OpenXmlLeafElement
  {
    ...
    public EnumValue<NumberSpacingValues> Val
    {
      get
      {
        return (EnumValue<NumberSpacingValues>) this.Attributes[0];
      }
      set
      {
    ...
    internal override OpenXmlSimpleType AttributeFactory(byte namespaceId, string name)
    {
      if (52 == (int) namespaceId && "val" == name)
        return (OpenXmlSimpleType) new EnumValue<NumberSpacingValues>();
      return base.AttributeFactory(namespaceId, name);
    }

    public override OpenXmlElement CloneNode(bool deep)
    {
      return (OpenXmlElement) this.CloneImp<NumberSpacing>(deep);
    }
  }
}
