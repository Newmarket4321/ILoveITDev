...
// Type: DocumentFormat.OpenXml.Office2010.Word.DrawingShape.ShapeProperties
  ...
  public class ShapeProperties : OpenXmlCompositeElement
  {
    ...
    internal override OpenXmlElement ElementFactory(byte namespaceId, string name)
    {
      if (10 == (int) namespaceId && "xfrm" == name)
        return (OpenXmlElement) new DocumentFormat.OpenXml.Drawing.Transform2D();
    ...
    public DocumentFormat.OpenXml.Drawing.Transform2D Transform2D
    {
      get
      {
        return this.GetElement<DocumentFormat.OpenXml.Drawing.Transform2D>(0);
      }
      set
      {
        this.SetElement<DocumentFormat.OpenXml.Drawing.Transform2D>(0, value);
      }
    }
