...
// Type: DocumentFormat.OpenXml.Office2010.Word.DrawingShape.TextBoxInfo2
...
namespace DocumentFormat.OpenXml.Office2010.Word.DrawingShape
{
  ...
  public class TextBoxInfo2 : OpenXmlCompositeElement
  {
    ...
    public TextBoxContent TextBoxContent
    {
      get
      {
        return this.GetElement<TextBoxContent>(0);
      }
      set
      {
        this.SetElement<TextBoxContent>(0, value);
      }
    }
    ...
    {
      return (OpenXmlElement) this.CloneImp<TextBoxInfo2>(deep);
    }
  }
}
