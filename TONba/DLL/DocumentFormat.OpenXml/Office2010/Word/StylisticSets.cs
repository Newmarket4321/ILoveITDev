...
// Type: DocumentFormat.OpenXml.Office2010.Word.StylisticSets
...
{
  [ChildElementInfo(typeof (StyleSet), FileFormatVersions.Office2010 | FileFormatVersions.Office2013)]
  ...
  public class StylisticSets : OpenXmlCompositeElement
  {
    ...
    {
      if (52 == (int) namespaceId && "styleSet" == name)
        return (OpenXmlElement) new StyleSet();
      return (OpenXmlElement) null;
    }

    public override OpenXmlElement CloneNode(bool deep)
    {
      return (OpenXmlElement) this.CloneImp<StylisticSets>(deep);
    }
  }
}
