...
// Type: DocumentFormat.OpenXml.Office2010.Excel.DefinedName
...
{
  [ChildElementInfo(typeof (ArgumentDescriptions), FileFormatVersions.Office2010 | FileFormatVersions.Office2013)]
  [OfficeAvailability(FileFormatVersions.Office2010)]
  [GeneratedCode("DomGen", "2.0")]
  public class DefinedName : OpenXmlCompositeElement
  {
    ...
    {
      if (53 == (int) namespaceId && "argumentDescriptions" == name)
        return (OpenXmlElement) new ArgumentDescriptions();
    ...
    public ArgumentDescriptions ArgumentDescriptions
    {
      get
      {
        return this.GetElement<ArgumentDescriptions>(0);
      }
      set
      {
        this.SetElement<ArgumentDescriptions>(0, value);
      }
    }
