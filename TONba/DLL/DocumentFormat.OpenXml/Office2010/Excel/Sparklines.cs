...
namespace DocumentFormat.OpenXml.Office2010.Excel
{
  ...
  [ChildElementInfo(typeof (Sparkline), FileFormatVersions.Office2010 | FileFormatVersions.Office2013)]
  [OfficeAvailability(FileFormatVersions.Office2010)]
  public class Sparklines : OpenXmlCompositeElement
  {
    ...
    {
      if (53 == (int) namespaceId && "sparkline" == name)
        return (OpenXmlElement) new Sparkline();
      return (OpenXmlElement) null;
    }

    public override OpenXmlElement CloneNode(bool deep)
    {
      return (OpenXmlElement) this.CloneImp<Sparklines>(deep);
    }
  }
}
