...
{
  [ChildElementInfo(typeof (TupleSetRow), FileFormatVersions.Office2010 | FileFormatVersions.Office2013)]
  [GeneratedCode("DomGen", "2.0")]
  [OfficeAvailability(FileFormatVersions.Office2010)]
  public class TupleSetRows : OpenXmlCompositeElement
  {
    ...
    {
      if (53 == (int) namespaceId && "row" == name)
        return (OpenXmlElement) new TupleSetRow();
      return (OpenXmlElement) null;
    }

    public override OpenXmlElement CloneNode(bool deep)
    {
      return (OpenXmlElement) this.CloneImp<TupleSetRows>(deep);
    }
  }
}
