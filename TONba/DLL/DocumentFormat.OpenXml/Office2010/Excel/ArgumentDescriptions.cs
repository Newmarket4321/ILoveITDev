...
// Type: DocumentFormat.OpenXml.Office2010.Excel.ArgumentDescriptions
...
{
  [ChildElementInfo(typeof (ArgumentDescription), FileFormatVersions.Office2010 | FileFormatVersions.Office2013)]
  [GeneratedCode("DomGen", "2.0")]
  [OfficeAvailability(FileFormatVersions.Office2010)]
  public class ArgumentDescriptions : OpenXmlCompositeElement
  {
    ...
    {
      if (53 == (int) namespaceId && "argumentDescription" == name)
        return (OpenXmlElement) new ArgumentDescription();
    ...
    {
      return (OpenXmlElement) this.CloneImp<ArgumentDescriptions>(deep);
    }
  }
}
