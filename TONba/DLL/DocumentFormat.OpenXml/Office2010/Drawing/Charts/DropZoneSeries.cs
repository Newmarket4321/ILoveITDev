...
// Type: DocumentFormat.OpenXml.Office2010.Drawing.Charts.DropZoneSeries
...
namespace DocumentFormat.OpenXml.Office2010.Drawing.Charts
{
  ...
  public class DropZoneSeries : BooleanFalseType
  {
    ...
    {
      return (OpenXmlElement) this.CloneImp<DropZoneSeries>(deep);
    }
  }
}
