...
// Type: DocumentFormat.OpenXml.Office2010.Drawing.ArtisticTexturizer
...
namespace DocumentFormat.OpenXml.Office2010.Drawing
{
  ...
  public class ArtisticTexturizer : OpenXmlLeafElement
  {
    ...
    internal override OpenXmlSimpleType AttributeFactory(byte namespaceId, string name)
    {
      ...
      if ((int) namespaceId == 0 && "scaling" == name)
        return (OpenXmlSimpleType) new Int32Value();
    ...
    {
      return (OpenXmlElement) this.CloneImp<ArtisticTexturizer>(deep);
    }
  }
}
