...
// Type: DocumentFormat.OpenXml.Office2010.Drawing.ArtisticWatercolorSponge
...
namespace DocumentFormat.OpenXml.Office2010.Drawing
{
  ...
  public class ArtisticWatercolorSponge : OpenXmlLeafElement
  {
    ...
    internal override OpenXmlSimpleType AttributeFactory(byte namespaceId, string name)
    {
      ...
      if ((int) namespaceId == 0 && "brushSize" == name)
        return (OpenXmlSimpleType) new Int32Value();
    ...
    {
      return (OpenXmlElement) this.CloneImp<ArtisticWatercolorSponge>(deep);
    }
  }
}
