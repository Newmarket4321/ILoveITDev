...
// Type: DocumentFormat.OpenXml.Office2010.PowerPoint.LeftRightDirectionTransitionType
...
namespace DocumentFormat.OpenXml.Office2010.PowerPoint
{
  ...
  public abstract class LeftRightDirectionTransitionType : OpenXmlLeafElement
  {
    ...
    public EnumValue<TransitionLeftRightDirectionTypeValues> Direction
    {
      get
      {
        return (EnumValue<TransitionLeftRightDirectionTypeValues>) this.Attributes[0];
      }
      set
      {
