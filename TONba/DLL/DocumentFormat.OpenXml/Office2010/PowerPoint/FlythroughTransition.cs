...
// Type: DocumentFormat.OpenXml.Office2010.PowerPoint.FlythroughTransition
...
namespace DocumentFormat.OpenXml.Office2010.PowerPoint
{
  ...
  public class FlythroughTransition : OpenXmlLeafElement
  {
    ...
    internal override OpenXmlSimpleType AttributeFactory(byte namespaceId, string name)
    {
      ...
      if ((int) namespaceId == 0 && "hasBounce" == name)
    ...
    {
      return (OpenXmlElement) this.CloneImp<FlythroughTransition>(deep);
    }
  }
}
