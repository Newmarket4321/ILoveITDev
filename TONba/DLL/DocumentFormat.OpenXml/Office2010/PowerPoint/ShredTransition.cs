...
// Type: DocumentFormat.OpenXml.Office2010.PowerPoint.ShredTransition
...
namespace DocumentFormat.OpenXml.Office2010.PowerPoint
{
  ...
  public class ShredTransition : OpenXmlLeafElement
  {
    ...
    public EnumValue<TransitionShredPatternValues> Pattern
    {
      get
      {
        return (EnumValue<TransitionShredPatternValues>) this.Attributes[0];
      }
      set
      {
    ...
    internal override OpenXmlSimpleType AttributeFactory(byte namespaceId, string name)
    {
      if ((int) namespaceId == 0 && "pattern" == name)
        return (OpenXmlSimpleType) new EnumValue<TransitionShredPatternValues>();
    ...
    {
      return (OpenXmlElement) this.CloneImp<ShredTransition>(deep);
    }
  }
}
