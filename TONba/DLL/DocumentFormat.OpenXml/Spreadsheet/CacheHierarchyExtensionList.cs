...
// Type: DocumentFormat.OpenXml.Spreadsheet.CacheHierarchyExtensionList
...
namespace DocumentFormat.OpenXml.Spreadsheet
{
  ...
  public class CacheHierarchyExtensionList : OpenXmlCompositeElement
  {
    ...
    internal override OpenXmlElement ElementFactory(byte namespaceId, string name)
    {
      if (22 == (int) namespaceId && "ext" == name)
        return (OpenXmlElement) new CacheHierarchyExtension();
      return (OpenXmlElement) null;
    }

    public override OpenXmlElement CloneNode(bool deep)
    {
      return (OpenXmlElement) this.CloneImp<CacheHierarchyExtensionList>(deep);
    }
  }
}
