...
// Type: DocumentFormat.OpenXml.Spreadsheet.CacheSourceExtension
...
namespace DocumentFormat.OpenXml.Spreadsheet
{
  ...
  public class CacheSourceExtension : OpenXmlCompositeElement
  {
    ...
    {
      if (53 == (int) namespaceId && "sourceConnection" == name)
        return (OpenXmlElement) new SourceConnection();
    ...
    {
      return (OpenXmlElement) this.CloneImp<CacheSourceExtension>(deep);
    }
  }
}
