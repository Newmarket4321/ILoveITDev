...
// Type: DocumentFormat.OpenXml.Spreadsheet.FieldsUsage
...
namespace DocumentFormat.OpenXml.Spreadsheet
{
  ...
  public class FieldsUsage : OpenXmlCompositeElement
  {
    ...
    {
      if (22 == (int) namespaceId && "fieldUsage" == name)
        return (OpenXmlElement) new FieldUsage();
    ...
    {
      return (OpenXmlElement) this.CloneImp<FieldsUsage>(deep);
    }
  }
}
