...
// Type: DocumentFormat.OpenXml.Spreadsheet.QueryTableDeletedFields
...
namespace DocumentFormat.OpenXml.Spreadsheet
{
  ...
  public class QueryTableDeletedFields : OpenXmlCompositeElement
  {
    ...
    {
      if (22 == (int) namespaceId && "deletedField" == name)
        return (OpenXmlElement) new DeletedField();
    ...
    {
      return (OpenXmlElement) this.CloneImp<QueryTableDeletedFields>(deep);
    }
  }
}
