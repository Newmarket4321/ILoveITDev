...
// Type: DocumentFormat.OpenXml.Spreadsheet.PivotHierarchies
...
namespace DocumentFormat.OpenXml.Spreadsheet
{
  ...
  public class PivotHierarchies : OpenXmlCompositeElement
  {
    ...
    {
      if (22 == (int) namespaceId && "pivotHierarchy" == name)
        return (OpenXmlElement) new PivotHierarchy();
    ...
    {
      return (OpenXmlElement) this.CloneImp<PivotHierarchies>(deep);
    }
  }
}
