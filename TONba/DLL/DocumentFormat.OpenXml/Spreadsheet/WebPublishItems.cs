...
// Type: DocumentFormat.OpenXml.Spreadsheet.WebPublishItems
...
namespace DocumentFormat.OpenXml.Spreadsheet
{
  ...
  public class WebPublishItems : OpenXmlCompositeElement
  {
    ...
    {
      if (22 == (int) namespaceId && "webPublishItem" == name)
        return (OpenXmlElement) new WebPublishItem();
    ...
    {
      return (OpenXmlElement) this.CloneImp<WebPublishItems>(deep);
    }
  }
}
