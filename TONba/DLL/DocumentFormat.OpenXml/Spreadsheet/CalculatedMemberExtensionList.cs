...
// Type: DocumentFormat.OpenXml.Spreadsheet.CalculatedMemberExtensionList
...
namespace DocumentFormat.OpenXml.Spreadsheet
{
  ...
  public class CalculatedMemberExtensionList : OpenXmlCompositeElement
  {
    ...
    internal override OpenXmlElement ElementFactory(byte namespaceId, string name)
    {
      if (22 == (int) namespaceId && "ext" == name)
        return (OpenXmlElement) new CalculatedMemberExtension();
      return (OpenXmlElement) null;
    }

    public override OpenXmlElement CloneNode(bool deep)
    {
      return (OpenXmlElement) this.CloneImp<CalculatedMemberExtensionList>(deep);
    }
  }
}
