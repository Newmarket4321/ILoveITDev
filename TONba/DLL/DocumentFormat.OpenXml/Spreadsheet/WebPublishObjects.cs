...
// Type: DocumentFormat.OpenXml.Spreadsheet.WebPublishObjects
...
namespace DocumentFormat.OpenXml.Spreadsheet
{
  ...
  public class WebPublishObjects : OpenXmlCompositeElement
  {
    ...
    {
      if (22 == (int) namespaceId && "webPublishObject" == name)
        return (OpenXmlElement) new WebPublishObject();
    ...
    {
      return (OpenXmlElement) this.CloneImp<WebPublishObjects>(deep);
    }
  }
}
