...
// Type: DocumentFormat.OpenXml.Spreadsheet.PivotHierarchyExtension
...
namespace DocumentFormat.OpenXml.Spreadsheet
{
  ...
  public class PivotHierarchyExtension : OpenXmlCompositeElement
  {
    ...
    {
      if (53 == (int) namespaceId && "pivotHierarchy" == name)
        return (OpenXmlElement) new DocumentFormat.OpenXml.Office2010.Excel.PivotHierarchy();
    ...
    {
      return (OpenXmlElement) this.CloneImp<PivotHierarchyExtension>(deep);
    }
  }
}
