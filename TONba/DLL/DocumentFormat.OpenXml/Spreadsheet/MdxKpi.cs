...
// Type: DocumentFormat.OpenXml.Spreadsheet.MdxKpi
...
namespace DocumentFormat.OpenXml.Spreadsheet
{
  ...
  public class MdxKpi : OpenXmlLeafElement
  {
    ...
    public EnumValue<MdxKPIPropertyValues> KpiProperty
    {
      get
      {
        return (EnumValue<MdxKPIPropertyValues>) this.Attributes[2];
      }
      set
      {
    ...
    internal override OpenXmlSimpleType AttributeFactory(byte namespaceId, string name)
    {
      ...
      if ((int) namespaceId == 0 && "np" == name)
        return (OpenXmlSimpleType) new UInt32Value();
      if ((int) namespaceId == 0 && "p" == name)
        return (OpenXmlSimpleType) new EnumValue<MdxKPIPropertyValues>();
      return base.AttributeFactory(namespaceId, name);
    }

    public override OpenXmlElement CloneNode(bool deep)
    {
      return (OpenXmlElement) this.CloneImp<MdxKpi>(deep);
    }
  }
}
