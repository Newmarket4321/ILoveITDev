...
// Type: DocumentFormat.OpenXml.Spreadsheet.CacheFieldExtensionList
...
namespace DocumentFormat.OpenXml.Spreadsheet
{
  ...
  public class CacheFieldExtensionList : OpenXmlCompositeElement
  {
    ...
    internal override OpenXmlElement ElementFactory(byte namespaceId, string name)
    {
      if (22 == (int) namespaceId && "ext" == name)
        return (OpenXmlElement) new CacheFieldExtension();
      return (OpenXmlElement) null;
    }

    public override OpenXmlElement CloneNode(bool deep)
    {
      return (OpenXmlElement) this.CloneImp<CacheFieldExtensionList>(deep);
    }
  }
}
