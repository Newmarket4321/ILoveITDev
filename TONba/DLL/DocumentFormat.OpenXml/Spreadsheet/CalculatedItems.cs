...
// Type: DocumentFormat.OpenXml.Spreadsheet.CalculatedItems
...
namespace DocumentFormat.OpenXml.Spreadsheet
{
  ...
  public class CalculatedItems : OpenXmlCompositeElement
  {
    ...
    {
      if (22 == (int) namespaceId && "calculatedItem" == name)
        return (OpenXmlElement) new CalculatedItem();
    ...
    {
      return (OpenXmlElement) this.CloneImp<CalculatedItems>(deep);
    }
  }
}
