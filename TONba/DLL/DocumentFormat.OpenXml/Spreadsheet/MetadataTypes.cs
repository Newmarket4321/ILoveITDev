...
// Type: DocumentFormat.OpenXml.Spreadsheet.MetadataTypes
...
namespace DocumentFormat.OpenXml.Spreadsheet
{
  ...
  public class MetadataTypes : OpenXmlCompositeElement
  {
    ...
    {
      if (22 == (int) namespaceId && "metadataType" == name)
        return (OpenXmlElement) new MetadataType();
    ...
    {
      return (OpenXmlElement) this.CloneImp<MetadataTypes>(deep);
    }
  }
}
