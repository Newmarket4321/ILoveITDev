...
// Type: DocumentFormat.OpenXml.Spreadsheet.Page
...
namespace DocumentFormat.OpenXml.Spreadsheet
{
  ...
  public class Page : OpenXmlCompositeElement
  {
    ...
    {
      if (22 == (int) namespaceId && "pageItem" == name)
        return (OpenXmlElement) new PageItem();
    ...
    {
      return (OpenXmlElement) this.CloneImp<Page>(deep);
    }
  }
}
