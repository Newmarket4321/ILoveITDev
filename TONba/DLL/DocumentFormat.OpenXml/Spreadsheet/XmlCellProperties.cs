...
namespace DocumentFormat.OpenXml.Spreadsheet
{
  ...
  public class XmlCellProperties : OpenXmlCompositeElement
  {
    ...
    {
      if (22 == (int) namespaceId && "xmlPr" == name)
        return (OpenXmlElement) new XmlProperties();
    ...
    public XmlProperties XmlProperties
    {
      get
      {
        return this.GetElement<XmlProperties>(0);
      }
      set
      {
        this.SetElement<XmlProperties>(0, value);
      }
    }
    ...
    {
      return (OpenXmlElement) this.CloneImp<XmlCellProperties>(deep);
    }
  }
}
