...
// Type: DocumentFormat.OpenXml.Spreadsheet.QueryTableFields
...
namespace DocumentFormat.OpenXml.Spreadsheet
{
  ...
  public class QueryTableFields : OpenXmlCompositeElement
  {
    ...
    {
      if (22 == (int) namespaceId && "queryTableField" == name)
        return (OpenXmlElement) new QueryTableField();
    ...
    {
      return (OpenXmlElement) this.CloneImp<QueryTableFields>(deep);
    }
  }
}
