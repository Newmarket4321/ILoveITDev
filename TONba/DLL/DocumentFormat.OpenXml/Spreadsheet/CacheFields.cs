...
namespace DocumentFormat.OpenXml.Spreadsheet
{
  ...
  public class CacheFields : OpenXmlCompositeElement
  {
    ...
    {
      if (22 == (int) namespaceId && "cacheField" == name)
        return (OpenXmlElement) new CacheField();
    ...
    {
      return (OpenXmlElement) this.CloneImp<CacheFields>(deep);
    }
  }
}
