...
// Type: DocumentFormat.OpenXml.Spreadsheet.CacheHierarchyExtension
...
namespace DocumentFormat.OpenXml.Spreadsheet
{
  ...
  public class CacheHierarchyExtension : OpenXmlCompositeElement
  {
    ...
    {
      if (53 == (int) namespaceId && "cacheHierarchy" == name)
        return (OpenXmlElement) new DocumentFormat.OpenXml.Office2010.Excel.CacheHierarchy();
      if (71 == (int) namespaceId && "cacheHierarchy" == name)
        return (OpenXmlElement) new DocumentFormat.OpenXml.Office2013.Excel.CacheHierarchy();
    ...
    {
      return (OpenXmlElement) this.CloneImp<CacheHierarchyExtension>(deep);
    }
  }
}
