...
// Type: DocumentFormat.OpenXml.Spreadsheet.CacheHierarchies
...
namespace DocumentFormat.OpenXml.Spreadsheet
{
  ...
  public class CacheHierarchies : OpenXmlCompositeElement
  {
    ...
    {
      if (22 == (int) namespaceId && "cacheHierarchy" == name)
        return (OpenXmlElement) new CacheHierarchy();
    ...
    {
      return (OpenXmlElement) this.CloneImp<CacheHierarchies>(deep);
    }
  }
}
