...
// Type: DocumentFormat.OpenXml.Spreadsheet.PivotFilters
...
namespace DocumentFormat.OpenXml.Spreadsheet
{
  ...
  public class PivotFilters : OpenXmlCompositeElement
  {
    ...
    internal override OpenXmlElement ElementFactory(byte namespaceId, string name)
    {
      if (22 == (int) namespaceId && "filter" == name)
        return (OpenXmlElement) new PivotFilter();
    ...
    {
      return (OpenXmlElement) this.CloneImp<PivotFilters>(deep);
    }
  }
}
