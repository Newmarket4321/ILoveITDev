...
// Type: DocumentFormat.OpenXml.Spreadsheet.MetadataStrings
...
namespace DocumentFormat.OpenXml.Spreadsheet
{
  ...
  public class MetadataStrings : OpenXmlCompositeElement
  {
    ...
    internal override OpenXmlElement ElementFactory(byte namespaceId, string name)
    {
      if (22 == (int) namespaceId && "s" == name)
        return (OpenXmlElement) new CharacterValue();
    ...
    {
      return (OpenXmlElement) this.CloneImp<MetadataStrings>(deep);
    }
  }
}
