...
// Type: DocumentFormat.OpenXml.Spreadsheet.ConditionalFormattingRuleExtensionList
...
namespace DocumentFormat.OpenXml.Spreadsheet
{
  ...
  public class ConditionalFormattingRuleExtensionList : OpenXmlCompositeElement
  {
    ...
    internal override OpenXmlElement ElementFactory(byte namespaceId, string name)
    {
      if (22 == (int) namespaceId && "ext" == name)
        return (OpenXmlElement) new ConditionalFormattingRuleExtension();
      return (OpenXmlElement) null;
    }

    public override OpenXmlElement CloneNode(bool deep)
    {
      return (OpenXmlElement) this.CloneImp<ConditionalFormattingRuleExtensionList>(deep);
    }
  }
}
