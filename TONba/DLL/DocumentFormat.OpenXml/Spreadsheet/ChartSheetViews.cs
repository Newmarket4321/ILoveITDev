...
// Type: DocumentFormat.OpenXml.Spreadsheet.ChartSheetViews
...
namespace DocumentFormat.OpenXml.Spreadsheet
{
  ...
  public class ChartSheetViews : OpenXmlCompositeElement
  {
    ...
    internal override OpenXmlElement ElementFactory(byte namespaceId, string name)
    {
      if (22 == (int) namespaceId && "sheetView" == name)
        return (OpenXmlElement) new ChartSheetView();
    ...
    {
      return (OpenXmlElement) this.CloneImp<ChartSheetViews>(deep);
    }
  }
}
