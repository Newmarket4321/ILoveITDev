...
namespace DocumentFormat.OpenXml.Spreadsheet
{
  ...
  public class ServerFormats : OpenXmlCompositeElement
  {
    ...
    {
      if (22 == (int) namespaceId && "serverFormat" == name)
        return (OpenXmlElement) new ServerFormat();
    ...
    {
      return (OpenXmlElement) this.CloneImp<ServerFormats>(deep);
    }
  }
}
