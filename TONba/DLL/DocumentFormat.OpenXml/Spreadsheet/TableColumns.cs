...
// Type: DocumentFormat.OpenXml.Spreadsheet.TableColumns
...
namespace DocumentFormat.OpenXml.Spreadsheet
{
  ...
  public class TableColumns : OpenXmlCompositeElement
  {
    ...
    {
      if (22 == (int) namespaceId && "tableColumn" == name)
        return (OpenXmlElement) new TableColumn();
    ...
    {
      return (OpenXmlElement) this.CloneImp<TableColumns>(deep);
    }
  }
}
