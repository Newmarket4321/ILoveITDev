...
// Type: DocumentFormat.OpenXml.Spreadsheet.MetadataBlock
...
namespace DocumentFormat.OpenXml.Spreadsheet
{
  ...
  public class MetadataBlock : OpenXmlCompositeElement
  {
    ...
    {
      if (22 == (int) namespaceId && "rc" == name)
        return (OpenXmlElement) new MetadataRecord();
      return (OpenXmlElement) null;
    }

    public override OpenXmlElement CloneNode(bool deep)
    {
      return (OpenXmlElement) this.CloneImp<MetadataBlock>(deep);
    }
  }
}
