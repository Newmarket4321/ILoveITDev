...
// Type: DocumentFormat.OpenXml.Spreadsheet.TableExtension
...
namespace DocumentFormat.OpenXml.Spreadsheet
{
  ...
  public class TableExtension : OpenXmlCompositeElement
  {
    ...
    {
      if (53 == (int) namespaceId && "table" == name)
        return (OpenXmlElement) new DocumentFormat.OpenXml.Office2010.Excel.Table();
    ...
    {
      return (OpenXmlElement) this.CloneImp<TableExtension>(deep);
    }
  }
}
