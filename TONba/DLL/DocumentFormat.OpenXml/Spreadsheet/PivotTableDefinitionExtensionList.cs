...
// Type: DocumentFormat.OpenXml.Spreadsheet.PivotTableDefinitionExtensionList
...
namespace DocumentFormat.OpenXml.Spreadsheet
{
  ...
  public class PivotTableDefinitionExtensionList : OpenXmlCompositeElement
  {
    ...
    internal override OpenXmlElement ElementFactory(byte namespaceId, string name)
    {
      if (22 == (int) namespaceId && "ext" == name)
        return (OpenXmlElement) new PivotTableDefinitionExtension();
      return (OpenXmlElement) null;
    }

    public override OpenXmlElement CloneNode(bool deep)
    {
      return (OpenXmlElement) this.CloneImp<PivotTableDefinitionExtensionList>(deep);
    }
  }
}
