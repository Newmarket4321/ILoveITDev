...
namespace DocumentFormat.OpenXml.Spreadsheet
{
  ...
  public class RangeSets : OpenXmlCompositeElement
  {
    ...
    {
      if (22 == (int) namespaceId && "rangeSet" == name)
        return (OpenXmlElement) new RangeSet();
    ...
    {
      return (OpenXmlElement) this.CloneImp<RangeSets>(deep);
    }
  }
}
