...
// Type: DocumentFormat.OpenXml.Spreadsheet.CellStyles
...
namespace DocumentFormat.OpenXml.Spreadsheet
{
  ...
  public class CellStyles : OpenXmlCompositeElement
  {
    ...
    {
      if (22 == (int) namespaceId && "cellStyle" == name)
        return (OpenXmlElement) new CellStyle();
    ...
    {
      return (OpenXmlElement) this.CloneImp<CellStyles>(deep);
    }
  }
}
