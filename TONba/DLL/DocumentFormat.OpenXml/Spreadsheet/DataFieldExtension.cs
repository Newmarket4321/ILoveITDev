...
// Type: DocumentFormat.OpenXml.Spreadsheet.DataFieldExtension
...
namespace DocumentFormat.OpenXml.Spreadsheet
{
  ...
  public class DataFieldExtension : OpenXmlCompositeElement
  {
    ...
    {
      if (53 == (int) namespaceId && "dataField" == name)
        return (OpenXmlElement) new DocumentFormat.OpenXml.Office2010.Excel.DataField();
      if (71 == (int) namespaceId && "dataField" == name)
        return (OpenXmlElement) new DocumentFormat.OpenXml.Office2013.Excel.DataField();
    ...
    {
      return (OpenXmlElement) this.CloneImp<DataFieldExtension>(deep);
    }
  }
}
