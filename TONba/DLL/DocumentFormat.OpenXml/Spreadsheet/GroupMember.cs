...
// Type: DocumentFormat.OpenXml.Spreadsheet.GroupMember
...
namespace DocumentFormat.OpenXml.Spreadsheet
{
  ...
  public class GroupMember : OpenXmlLeafElement
  {
    ...
    internal override OpenXmlSimpleType AttributeFactory(byte namespaceId, string name)
    {
      ...
      if ((int) namespaceId == 0 && "group" == name)
    ...
    {
      return (OpenXmlElement) this.CloneImp<GroupMember>(deep);
    }
  }
}
