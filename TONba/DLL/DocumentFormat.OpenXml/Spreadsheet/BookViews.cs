...
// Type: DocumentFormat.OpenXml.Spreadsheet.BookViews
...
namespace DocumentFormat.OpenXml.Spreadsheet
{
  ...
  public class BookViews : OpenXmlCompositeElement
  {
    ...
    {
      if (22 == (int) namespaceId && "workbookView" == name)
        return (OpenXmlElement) new WorkbookView();
      return (OpenXmlElement) null;
    }

    public override OpenXmlElement CloneNode(bool deep)
    {
      return (OpenXmlElement) this.CloneImp<BookViews>(deep);
    }
  }
}
