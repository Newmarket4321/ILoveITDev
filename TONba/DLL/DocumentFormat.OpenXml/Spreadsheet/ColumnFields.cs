...
// Type: DocumentFormat.OpenXml.Spreadsheet.ColumnFields
...
namespace DocumentFormat.OpenXml.Spreadsheet
{
  ...
  public class ColumnFields : OpenXmlCompositeElement
  {
    ...
    {
      if (22 == (int) namespaceId && "field" == name)
    ...
    {
      return (OpenXmlElement) this.CloneImp<ColumnFields>(deep);
    }
  }
}
