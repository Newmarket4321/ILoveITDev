...
// Type: DocumentFormat.OpenXml.Spreadsheet.MdxMetadata
...
namespace DocumentFormat.OpenXml.Spreadsheet
{
  ...
  public class MdxMetadata : OpenXmlCompositeElement
  {
    ...
    {
      if (22 == (int) namespaceId && "mdx" == name)
        return (OpenXmlElement) new Mdx();
    ...
    {
      return (OpenXmlElement) this.CloneImp<MdxMetadata>(deep);
    }
  }
}
