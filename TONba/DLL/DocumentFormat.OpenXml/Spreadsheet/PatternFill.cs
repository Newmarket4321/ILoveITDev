...
// Type: DocumentFormat.OpenXml.Spreadsheet.PatternFill
...
namespace DocumentFormat.OpenXml.Spreadsheet
{
  ...
  public class PatternFill : OpenXmlCompositeElement
  {
    ...
    public EnumValue<PatternValues> PatternType
    {
      get
      {
        return (EnumValue<PatternValues>) this.Attributes[0];
      }
      set
      {
    ...
    {
      if (22 == (int) namespaceId && "fgColor" == name)
        return (OpenXmlElement) new ForegroundColor();
      if (22 == (int) namespaceId && "bgColor" == name)
    ...
    {
      if ((int) namespaceId == 0 && "patternType" == name)
        return (OpenXmlSimpleType) new EnumValue<PatternValues>();
