...
namespace DocumentFormat.OpenXml.Spreadsheet
{
  ...
  public class SheetIdMap : OpenXmlCompositeElement
  {
    ...
    {
      if (22 == (int) namespaceId && "sheetId" == name)
        return (OpenXmlElement) new SheetId();
    ...
    {
      return (OpenXmlElement) this.CloneImp<SheetIdMap>(deep);
    }
  }
}
