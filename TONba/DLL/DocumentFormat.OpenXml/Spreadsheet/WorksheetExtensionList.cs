...
// Type: DocumentFormat.OpenXml.Spreadsheet.WorksheetExtensionList
...
namespace DocumentFormat.OpenXml.Spreadsheet
{
  ...
  public class WorksheetExtensionList : OpenXmlCompositeElement
  {
    ...
    internal override OpenXmlElement ElementFactory(byte namespaceId, string name)
    {
      if (22 == (int) namespaceId && "ext" == name)
        return (OpenXmlElement) new WorksheetExtension();
      return (OpenXmlElement) null;
    }

    public override OpenXmlElement CloneNode(bool deep)
    {
      return (OpenXmlElement) this.CloneImp<WorksheetExtensionList>(deep);
    }
  }
}
