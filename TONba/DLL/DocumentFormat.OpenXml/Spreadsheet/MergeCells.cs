...
// Type: DocumentFormat.OpenXml.Spreadsheet.MergeCells
...
namespace DocumentFormat.OpenXml.Spreadsheet
{
  ...
  public class MergeCells : OpenXmlCompositeElement
  {
    ...
    {
      if (22 == (int) namespaceId && "mergeCell" == name)
        return (OpenXmlElement) new MergeCell();
    ...
    {
      return (OpenXmlElement) this.CloneImp<MergeCells>(deep);
    }
  }
}
