...
// Type: DocumentFormat.OpenXml.Spreadsheet.PivotFieldExtension
...
namespace DocumentFormat.OpenXml.Spreadsheet
{
  ...
  public class PivotFieldExtension : OpenXmlCompositeElement
  {
    ...
    {
      if (53 == (int) namespaceId && "pivotField" == name)
        return (OpenXmlElement) new DocumentFormat.OpenXml.Office2010.Excel.PivotField();
    ...
    {
      return (OpenXmlElement) this.CloneImp<PivotFieldExtension>(deep);
    }
  }
}
