...
// Type: DocumentFormat.OpenXml.Spreadsheet.DataFields
...
namespace DocumentFormat.OpenXml.Spreadsheet
{
  ...
  public class DataFields : OpenXmlCompositeElement
  {
    ...
    {
      if (22 == (int) namespaceId && "dataField" == name)
        return (OpenXmlElement) new DataField();
    ...
    {
      return (OpenXmlElement) this.CloneImp<DataFields>(deep);
    }
  }
}
