...
// Type: DocumentFormat.OpenXml.Spreadsheet.MeasureGroups
...
namespace DocumentFormat.OpenXml.Spreadsheet
{
  ...
  public class MeasureGroups : OpenXmlCompositeElement
  {
    ...
    {
      if (22 == (int) namespaceId && "measureGroup" == name)
        return (OpenXmlElement) new MeasureGroup();
    ...
    {
      return (OpenXmlElement) this.CloneImp<MeasureGroups>(deep);
    }
  }
}
