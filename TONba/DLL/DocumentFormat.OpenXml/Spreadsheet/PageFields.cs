...
// Type: DocumentFormat.OpenXml.Spreadsheet.PageFields
...
namespace DocumentFormat.OpenXml.Spreadsheet
{
  ...
  public class PageFields : OpenXmlCompositeElement
  {
    ...
    {
      if (22 == (int) namespaceId && "pageField" == name)
        return (OpenXmlElement) new PageField();
    ...
    {
      return (OpenXmlElement) this.CloneImp<PageFields>(deep);
    }
  }
}
