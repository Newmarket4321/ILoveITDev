...
// Type: DocumentFormat.OpenXml.Spreadsheet.DataReferences
...
namespace DocumentFormat.OpenXml.Spreadsheet
{
  ...
  public class DataReferences : OpenXmlCompositeElement
  {
    ...
    {
      if (22 == (int) namespaceId && "dataRef" == name)
        return (OpenXmlElement) new DataReference();
    ...
    {
      return (OpenXmlElement) this.CloneImp<DataReferences>(deep);
    }
  }
}
