...
namespace DocumentFormat.OpenXml.VariantTypes
{
  ...
  public class VTUnsignedShort : OpenXmlLeafTextElement
  {
    ...
    internal override OpenXmlSimpleType InnerTextToValue(string text)
    {
      ...
      uint16Value.InnerText = text;
      return (OpenXmlSimpleType) uint16Value;
    }

    public override OpenXmlElement CloneNode(bool deep)
    {
      return (OpenXmlElement) this.CloneImp<VTUnsignedShort>(deep);
    }
  }
}
