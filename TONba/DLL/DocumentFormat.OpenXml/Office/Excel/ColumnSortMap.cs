...
namespace DocumentFormat.OpenXml.Office.Excel
{
  ...
  public class ColumnSortMap : OpenXmlCompositeElement
  {
    ...
    {
      if (32 == (int) namespaceId && "col" == name)
        return (OpenXmlElement) new ColumnSortMapItem();
    ...
    {
      return (OpenXmlElement) this.CloneImp<ColumnSortMap>(deep);
    }
  }
}
