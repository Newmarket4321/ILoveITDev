...
// Type: DocumentFormat.OpenXml.Office.CoverPageProps.CompanyAddress
...
namespace DocumentFormat.OpenXml.Office.CoverPageProps
{
  ...
  public class CompanyAddress : OpenXmlLeafTextElement
  {
    ...
    {
      return (OpenXmlElement) this.CloneImp<CompanyAddress>(deep);
    }
  }
}
