...
// Type: DocumentFormat.OpenXml.Office.CoverPageProps.DocumentAbstract
...
namespace DocumentFormat.OpenXml.Office.CoverPageProps
{
  ...
  public class DocumentAbstract : OpenXmlLeafTextElement
  {
    ...
    {
      return (OpenXmlElement) this.CloneImp<DocumentAbstract>(deep);
    }
  }
}
