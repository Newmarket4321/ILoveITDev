...
// Type: DocumentFormat.OpenXml.Office.CoverPageProps.CompanyEmailAddress
...
namespace DocumentFormat.OpenXml.Office.CoverPageProps
{
  ...
  public class CompanyEmailAddress : OpenXmlLeafTextElement
  {
    ...
    {
      return (OpenXmlElement) this.CloneImp<CompanyEmailAddress>(deep);
    }
  }
}
