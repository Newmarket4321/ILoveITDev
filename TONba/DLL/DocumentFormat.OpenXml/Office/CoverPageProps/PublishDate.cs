...
// Type: DocumentFormat.OpenXml.Office.CoverPageProps.PublishDate
...
namespace DocumentFormat.OpenXml.Office.CoverPageProps
{
  ...
  public class PublishDate : OpenXmlLeafTextElement
  {
    ...
    {
      return (OpenXmlElement) this.CloneImp<PublishDate>(deep);
    }
  }
}
