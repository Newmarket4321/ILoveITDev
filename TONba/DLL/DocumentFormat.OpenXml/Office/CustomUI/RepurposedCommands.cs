...
// Type: DocumentFormat.OpenXml.Office.CustomUI.RepurposedCommands
...
namespace DocumentFormat.OpenXml.Office.CustomUI
{
  ...
  public class RepurposedCommands : OpenXmlCompositeElement
  {
    ...
    {
      if (34 == (int) namespaceId && "command" == name)
        return (OpenXmlElement) new RepurposedCommand();
      return (OpenXmlElement) null;
    }

    public override OpenXmlElement CloneNode(bool deep)
    {
      return (OpenXmlElement) this.CloneImp<RepurposedCommands>(deep);
    }
  }
}
