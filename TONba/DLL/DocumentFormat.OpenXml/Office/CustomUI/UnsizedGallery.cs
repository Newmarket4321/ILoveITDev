...
// Type: DocumentFormat.OpenXml.Office.CustomUI.UnsizedGallery
...
namespace DocumentFormat.OpenXml.Office.CustomUI
{
  ...
  public class UnsizedGallery : OpenXmlCompositeElement
  {
    ...
    public IntegerValue Columns
    {
      get
      {
        return (IntegerValue) this.Attributes[3];
      }
      set
      {
    ...
    {
      if (34 == (int) namespaceId && "item" == name)
    ...
    {
      return (OpenXmlElement) this.CloneImp<UnsizedGallery>(deep);
    }
  }
}
