...
// Type: DocumentFormat.OpenXml.Office.CustomUI.QuickAccessToolbarControlClone
...
namespace DocumentFormat.OpenXml.Office.CustomUI
{
  ...
  public class QuickAccessToolbarControlClone : OpenXmlLeafElement
  {
    ...
    public EnumValue<SizeValues> Size
    {
      get
      {
        return (EnumValue<SizeValues>) this.Attributes[5];
      }
      set
      {
    ...
    {
      return (OpenXmlElement) this.CloneImp<QuickAccessToolbarControlClone>(deep);
    }
  }
}
