...
// Type: DocumentFormat.OpenXml.Office.CustomUI.Gallery
...
namespace DocumentFormat.OpenXml.Office.CustomUI
{
  ...
  {
    private static string[] attributeTagNames = new string[50]
    {
      "size",
      "getSize",
      "description",
    ...
    private static byte[] attributeNamespaceIds = new byte[50];
    ...
    public StringValue GetShowImage
    {
      get
      {
        return (StringValue) this.Attributes[49];
      }
      set
      {
