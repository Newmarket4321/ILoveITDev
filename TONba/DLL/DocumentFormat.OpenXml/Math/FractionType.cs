...
namespace DocumentFormat.OpenXml.Math
{
  ...
  public class FractionType : OpenXmlLeafElement
  {
    ...
    public EnumValue<FractionTypeValues> Val
    {
      get
      {
        return (EnumValue<FractionTypeValues>) this.Attributes[0];
      }
      set
      {
    ...
    internal override OpenXmlSimpleType AttributeFactory(byte namespaceId, string name)
    {
      if (21 == (int) namespaceId && "val" == name)
        return (OpenXmlSimpleType) new EnumValue<FractionTypeValues>();
      return base.AttributeFactory(namespaceId, name);
    }

    public override OpenXmlElement CloneNode(bool deep)
    {
      return (OpenXmlElement) this.CloneImp<FractionType>(deep);
    }
  }
}
