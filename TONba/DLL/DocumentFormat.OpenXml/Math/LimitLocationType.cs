...
// Type: DocumentFormat.OpenXml.Math.LimitLocationType
...
namespace DocumentFormat.OpenXml.Math
{
  ...
  public abstract class LimitLocationType : OpenXmlLeafElement
  {
    ...
    public EnumValue<LimitLocationValues> Val
    {
      get
      {
        return (EnumValue<LimitLocationValues>) this.Attributes[0];
      }
      set
      {
    ...
    internal override OpenXmlSimpleType AttributeFactory(byte namespaceId, string name)
    {
      if (21 == (int) namespaceId && "val" == name)
        return (OpenXmlSimpleType) new EnumValue<LimitLocationValues>();
