...
// Type: DocumentFormat.OpenXml.Math.BreakBinarySubtraction
...
namespace DocumentFormat.OpenXml.Math
{
  ...
  public class BreakBinarySubtraction : OpenXmlLeafElement
  {
    ...
    public EnumValue<BreakBinarySubtractionValues> Val
    {
      get
      {
        return (EnumValue<BreakBinarySubtractionValues>) this.Attributes[0];
      }
      set
      {
    ...
    internal override OpenXmlSimpleType AttributeFactory(byte namespaceId, string name)
    {
      if (21 == (int) namespaceId && "val" == name)
        return (OpenXmlSimpleType) new EnumValue<BreakBinarySubtractionValues>();
      return base.AttributeFactory(namespaceId, name);
    }

    public override OpenXmlElement CloneNode(bool deep)
    {
      return (OpenXmlElement) this.CloneImp<BreakBinarySubtraction>(deep);
    }
  }
}
