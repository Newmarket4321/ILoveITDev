...
// Type: DocumentFormat.OpenXml.EMMA.Interpretation
...
namespace DocumentFormat.OpenXml.EMMA
{
  ...
  public class Interpretation : OpenXmlCompositeElement
  {
    ...
    internal override OpenXmlElement ElementFactory(byte namespaceId, string name)
    {
      ...
      if (44 == (int) namespaceId && "lattice" == name)
        return (OpenXmlElement) new Lattice();
      if (44 == (int) namespaceId && "literal" == name)
        return (OpenXmlElement) new Literal();
      if (45 == (int) namespaceId && "context" == name)
        return (OpenXmlElement) new ContextNode();
    ...
    internal override OpenXmlSimpleType AttributeFactory(byte namespaceId, string name)
    {
      ...
      if (44 == (int) namespaceId && "dialog-turn" == name)
        return (OpenXmlSimpleType) new StringValue();
      if (44 == (int) namespaceId && "no-input" == name)
        return (OpenXmlSimpleType) new BooleanValue();
      if (44 == (int) namespaceId && "uninterpreted" == name)
        return (OpenXmlSimpleType) new BooleanValue();
    ...
    {
      return (OpenXmlElement) this.CloneImp<Interpretation>(deep);
    }
  }
}
