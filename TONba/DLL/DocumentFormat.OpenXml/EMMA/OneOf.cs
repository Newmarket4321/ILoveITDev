...
// Type: DocumentFormat.OpenXml.EMMA.OneOf
...
namespace DocumentFormat.OpenXml.EMMA
{
  ...
  {
    private static string[] attributeTagNames = new string[25]
    {
      "disjunction-type",
      "id",
      "tokens",
    ...
    private static byte[] attributeNamespaceIds = new byte[25]
    {
      (byte) 0,
      (byte) 0,
      (byte) 44,
    ...
    public EnumValue<DisjunctionTypeValues> DisjunctionType
    {
      get
      {
        return (EnumValue<DisjunctionTypeValues>) this.Attributes[0];
      }
      set
      {
    ...
    public DecimalValue Confidence
    {
      get
      {
        return (DecimalValue) this.Attributes[8];
      }
      set
      {
    ...
    public UInt64Value End
    {
      get
      {
        return (UInt64Value) this.Attributes[11];
      }
      set
      {
    ...
    public EnumValue<AnchorPointValues> TimeReferenceAnchorPoint
    {
      get
      {
        return (EnumValue<AnchorPointValues>) this.Attributes[13];
      }
      set
      {
    ...
    public IntegerValue Duration
    {
      get
      {
        return (IntegerValue) this.Attributes[15];
      }
      set
      {
    ...
    public ListValue<EnumValue<MediumValues>> Medium
    {
      get
      {
        return (ListValue<EnumValue<MediumValues>>) this.Attributes[16];
      }
      set
      {
    ...
    public ListValue<StringValue> Mode
    {
      get
      {
        return (ListValue<StringValue>) this.Attributes[17];
      }
      set
      {
    ...
    public DecimalValue Cost
    {
      get
      {
        return (DecimalValue) this.Attributes[20];
      }
      set
      {
    ...
    {
      if ((int) namespaceId == 0 && "disjunction-type" == name)
        return (OpenXmlSimpleType) new EnumValue<DisjunctionTypeValues>();
    ...
    {
      return (OpenXmlElement) this.CloneImp<OneOf>(deep);
    }
  }
}
