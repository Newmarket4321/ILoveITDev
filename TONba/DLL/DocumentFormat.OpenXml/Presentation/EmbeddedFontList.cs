...
namespace DocumentFormat.OpenXml.Presentation
{
  ...
  public class EmbeddedFontList : OpenXmlCompositeElement
  {
    ...
    {
      if (24 == (int) namespaceId && "embeddedFont" == name)
        return (OpenXmlElement) new EmbeddedFont();
      return (OpenXmlElement) null;
    }

    public override OpenXmlElement CloneNode(bool deep)
    {
      return (OpenXmlElement) this.CloneImp<EmbeddedFontList>(deep);
    }
  }
}
