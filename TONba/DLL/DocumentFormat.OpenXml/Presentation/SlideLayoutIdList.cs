...
namespace DocumentFormat.OpenXml.Presentation
{
  ...
  public class SlideLayoutIdList : OpenXmlCompositeElement
  {
    ...
    {
      if (24 == (int) namespaceId && "sldLayoutId" == name)
        return (OpenXmlElement) new SlideLayoutId();
      return (OpenXmlElement) null;
    }

    public override OpenXmlElement CloneNode(bool deep)
    {
      return (OpenXmlElement) this.CloneImp<SlideLayoutIdList>(deep);
    }
  }
}
