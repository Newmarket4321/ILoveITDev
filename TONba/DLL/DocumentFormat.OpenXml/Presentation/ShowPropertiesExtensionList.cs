...
// Type: DocumentFormat.OpenXml.Presentation.ShowPropertiesExtensionList
...
namespace DocumentFormat.OpenXml.Presentation
{
  ...
  public class ShowPropertiesExtensionList : OpenXmlCompositeElement
  {
    ...
    internal override OpenXmlElement ElementFactory(byte namespaceId, string name)
    {
      if (24 == (int) namespaceId && "ext" == name)
        return (OpenXmlElement) new ShowPropertiesExtension();
      return (OpenXmlElement) null;
    }

    public override OpenXmlElement CloneNode(bool deep)
    {
      return (OpenXmlElement) this.CloneImp<ShowPropertiesExtensionList>(deep);
    }
  }
}
