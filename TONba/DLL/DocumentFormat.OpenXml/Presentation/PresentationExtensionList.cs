...
// Type: DocumentFormat.OpenXml.Presentation.PresentationExtensionList
...
namespace DocumentFormat.OpenXml.Presentation
{
  ...
  public class PresentationExtensionList : OpenXmlCompositeElement
  {
    ...
    internal override OpenXmlElement ElementFactory(byte namespaceId, string name)
    {
      if (24 == (int) namespaceId && "ext" == name)
        return (OpenXmlElement) new PresentationExtension();
      return (OpenXmlElement) null;
    }

    public override OpenXmlElement CloneNode(bool deep)
    {
      return (OpenXmlElement) this.CloneImp<PresentationExtensionList>(deep);
    }
  }
}
