...
namespace DocumentFormat.OpenXml.Presentation
{
  ...
  public class RuntimeNodeTrigger : OpenXmlLeafElement
  {
    ...
    public EnumValue<TriggerRuntimeNodeValues> Val
    {
      get
      {
        return (EnumValue<TriggerRuntimeNodeValues>) this.Attributes[0];
      }
      set
      {
    ...
    internal override OpenXmlSimpleType AttributeFactory(byte namespaceId, string name)
    {
      if ((int) namespaceId == 0 && "val" == name)
        return (OpenXmlSimpleType) new EnumValue<TriggerRuntimeNodeValues>();
      return base.AttributeFactory(namespaceId, name);
    }

    public override OpenXmlElement CloneNode(bool deep)
    {
      return (OpenXmlElement) this.CloneImp<RuntimeNodeTrigger>(deep);
    }
  }
}
