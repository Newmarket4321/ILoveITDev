...
// Type: DocumentFormat.OpenXml.Presentation.StripsTransition
...
namespace DocumentFormat.OpenXml.Presentation
{
  ...
  public class StripsTransition : OpenXmlLeafElement
  {
    ...
    public EnumValue<TransitionCornerDirectionValues> Direction
    {
      get
      {
        return (EnumValue<TransitionCornerDirectionValues>) this.Attributes[0];
      }
      set
      {
    ...
    internal override OpenXmlSimpleType AttributeFactory(byte namespaceId, string name)
    {
      if ((int) namespaceId == 0 && "dir" == name)
        return (OpenXmlSimpleType) new EnumValue<TransitionCornerDirectionValues>();
      return base.AttributeFactory(namespaceId, name);
    }

    public override OpenXmlElement CloneNode(bool deep)
    {
      return (OpenXmlElement) this.CloneImp<StripsTransition>(deep);
    }
  }
}
