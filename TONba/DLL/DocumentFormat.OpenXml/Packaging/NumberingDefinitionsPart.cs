...
// Type: DocumentFormat.OpenXml.Packaging.NumberingDefinitionsPart
...
{
  public class NumberingDefinitionsPart : OpenXmlPart, IFixedContentTypePart
  {
    ...
    internal override sealed IDictionary<string, PartConstraintRule> GetPartConstraint()
    {
      ...
      return (IDictionary<string, PartConstraintRule>) NumberingDefinitionsPart._partConstraint;
    }

    internal override sealed IDictionary<string, PartConstraintRule> GetDataPartReferenceConstraint()
    {
      if (NumberingDefinitionsPart._dataPartReferenceConstraint == null)
        NumberingDefinitionsPart._dataPartReferenceConstraint = new Dictionary<string, PartConstraintRule>();
      return (IDictionary<string, PartConstraintRule>) NumberingDefinitionsPart._dataPartReferenceConstraint;
    }
    ...
    internal override OpenXmlPartRootElement PartRootElement
    {
      get
      {
        return (OpenXmlPartRootElement) this.Numbering;
      }
    }
