...
{
  public class FooterPart : OpenXmlPart, IFixedContentTypePart
  {
    ...
    internal override sealed IDictionary<string, PartConstraintRule> GetPartConstraint()
    {
      ...
      return (IDictionary<string, PartConstraintRule>) FooterPart._partConstraint;
    }
    ...
    internal override sealed IDictionary<string, PartConstraintRule> GetDataPartReferenceConstraint()
    {
      ...
      return (IDictionary<string, PartConstraintRule>) FooterPart._dataPartReferenceConstraint;
    }
    ...
    internal override OpenXmlPartRootElement PartRootElement
    {
      get
      {
        return (OpenXmlPartRootElement) this.Footer;
      }
    }
