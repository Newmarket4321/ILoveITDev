  ...
  public class EmbeddedObjectPart : OpenXmlPart
  {
    ...
    internal override sealed IDictionary<string, PartConstraintRule> GetPartConstraint()
    {
      if (EmbeddedObjectPart._partConstraint == null)
        EmbeddedObjectPart._partConstraint = new Dictionary<string, PartConstraintRule>();
      return (IDictionary<string, PartConstraintRule>) EmbeddedObjectPart._partConstraint;
    }

    internal override sealed IDictionary<string, PartConstraintRule> GetDataPartReferenceConstraint()
    {
      if (EmbeddedObjectPart._dataPartReferenceConstraint == null)
        EmbeddedObjectPart._dataPartReferenceConstraint = new Dictionary<string, PartConstraintRule>();
      return (IDictionary<string, PartConstraintRule>) EmbeddedObjectPart._dataPartReferenceConstraint;
    }
