...
// Type: DocumentFormat.OpenXml.Packaging.WebExtensionPart
...
namespace DocumentFormat.OpenXml.Packaging
{
  ...
  public class WebExtensionPart : OpenXmlPart, IFixedContentTypePart
  {
    ...
    internal const string TargetNameConstant = "webextension";
    private static Dictionary<string, PartConstraintRule> _partConstraint;
    private static Dictionary<string, PartConstraintRule> _dataPartReferenceConstraint;
    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private DocumentFormat.OpenXml.Office2013.WebExtension.WebExtension _rootEle;

    internal override sealed IDictionary<string, PartConstraintRule> GetPartConstraint()
    {
      if (WebExtensionPart._partConstraint == null)
        WebExtensionPart._partConstraint = new Dictionary<string, PartConstraintRule>()
        {
          {
      ...
      return (IDictionary<string, PartConstraintRule>) WebExtensionPart._partConstraint;
    }

    internal override sealed IDictionary<string, PartConstraintRule> GetDataPartReferenceConstraint()
    {
      if (WebExtensionPart._dataPartReferenceConstraint == null)
        WebExtensionPart._dataPartReferenceConstraint = new Dictionary<string, PartConstraintRule>();
      return (IDictionary<string, PartConstraintRule>) WebExtensionPart._dataPartReferenceConstraint;
    }

    protected internal WebExtensionPart()
    {
    }
    ...
    public override sealed string RelationshipType
    {
      get
      {
        return "http://schemas.microsoft.com/office/2011/relationships/webextension";
      }
    }
    ...
    public override sealed string ContentType
    {
      get
      {
        return "application/vnd.ms-office.webextension+xml";
      }
    }
    ...
    internal override OpenXmlPartRootElement _rootElement
    {
      ...
      set
      {
        this._rootEle = value as DocumentFormat.OpenXml.Office2013.WebExtension.WebExtension;
      }
    }
    ...
    internal override OpenXmlPartRootElement PartRootElement
    {
      get
      {
        return (OpenXmlPartRootElement) this.WebExtension;
      }
    }
    ...
    public DocumentFormat.OpenXml.Office2013.WebExtension.WebExtension WebExtension
    {
      get
      {
        if (this._rootEle == null)
          this.LoadDomTree<DocumentFormat.OpenXml.Office2013.WebExtension.WebExtension>();
