...
// Type: DocumentFormat.OpenXml.Packaging.VolatileDependenciesPart
...
{
  public class VolatileDependenciesPart : OpenXmlPart, IFixedContentTypePart
  {
    ...
    internal override sealed IDictionary<string, PartConstraintRule> GetPartConstraint()
    {
      if (VolatileDependenciesPart._partConstraint == null)
        VolatileDependenciesPart._partConstraint = new Dictionary<string, PartConstraintRule>();
      return (IDictionary<string, PartConstraintRule>) VolatileDependenciesPart._partConstraint;
    }

    internal override sealed IDictionary<string, PartConstraintRule> GetDataPartReferenceConstraint()
    {
      if (VolatileDependenciesPart._dataPartReferenceConstraint == null)
        VolatileDependenciesPart._dataPartReferenceConstraint = new Dictionary<string, PartConstraintRule>();
      return (IDictionary<string, PartConstraintRule>) VolatileDependenciesPart._dataPartReferenceConstraint;
    }
    ...
    internal override OpenXmlPartRootElement PartRootElement
    {
      get
      {
        return (OpenXmlPartRootElement) this.VolatileTypes;
      }
    }
    ...
    public VolatileTypes VolatileTypes
    {
      get
      {
        if (this._rootEle == null)
          this.LoadDomTree<VolatileTypes>();
