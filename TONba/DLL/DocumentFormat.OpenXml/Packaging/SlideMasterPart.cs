...
{
  public class SlideMasterPart : OpenXmlPart, IFixedContentTypePart
  {
    ...
    internal override sealed IDictionary<string, PartConstraintRule> GetPartConstraint()
    {
      if (SlideMasterPart._partConstraint == null)
        SlideMasterPart._partConstraint = new Dictionary<string, PartConstraintRule>()
        {
          ...
          },
          {
            ...
            new PartConstraintRule("SlideLayoutPart", "application/vnd.openxmlformats-officedocument.presentationml.slideLayout+xml", false, true, FileFormatVersions.Office2007 | FileFormatVersions.Office2010 | FileFormatVersions.Office2013)
          },
          {
      ...
      return (IDictionary<string, PartConstraintRule>) SlideMasterPart._partConstraint;
    }
    ...
    internal override sealed IDictionary<string, PartConstraintRule> GetDataPartReferenceConstraint()
    {
      ...
      return (IDictionary<string, PartConstraintRule>) SlideMasterPart._dataPartReferenceConstraint;
    }
    ...
    internal override OpenXmlPartRootElement PartRootElement
    {
      get
      {
        return (OpenXmlPartRootElement) this.SlideMaster;
      }
    }
