...
// Type: DocumentFormat.OpenXml.Packaging.WordprocessingCommentsExPart
...
namespace DocumentFormat.OpenXml.Packaging
{
  ...
  public class WordprocessingCommentsExPart : OpenXmlPart, IFixedContentTypePart
  {
    ...
    internal const string TargetNameConstant = "commentsExtended";
    private static Dictionary<string, PartConstraintRule> _partConstraint;
    private static Dictionary<string, PartConstraintRule> _dataPartReferenceConstraint;
    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private CommentsEx _rootEle;

    internal override sealed IDictionary<string, PartConstraintRule> GetPartConstraint()
    {
      if (WordprocessingCommentsExPart._partConstraint == null)
        WordprocessingCommentsExPart._partConstraint = new Dictionary<string, PartConstraintRule>()
        {
          {
      ...
      return (IDictionary<string, PartConstraintRule>) WordprocessingCommentsExPart._partConstraint;
    }

    internal override sealed IDictionary<string, PartConstraintRule> GetDataPartReferenceConstraint()
    {
      if (WordprocessingCommentsExPart._dataPartReferenceConstraint == null)
        WordprocessingCommentsExPart._dataPartReferenceConstraint = new Dictionary<string, PartConstraintRule>()
        {
          {
      ...
      return (IDictionary<string, PartConstraintRule>) WordprocessingCommentsExPart._dataPartReferenceConstraint;
    }

    protected internal WordprocessingCommentsExPart()
    {
    }
    ...
    public override sealed string ContentType
    {
      get
      {
        return "application/vnd.openxmlformats-officedocument.wordprocessingml.commentsExtended+xml";
      }
    }
    ...
    internal override OpenXmlPartRootElement _rootElement
    {
      ...
      set
      {
        this._rootEle = value as CommentsEx;
      }
    }
    ...
    internal override OpenXmlPartRootElement PartRootElement
    {
      get
      {
        return (OpenXmlPartRootElement) this.CommentsEx;
      }
    }

    public CommentsEx CommentsEx
    {
      get
      {
        if (this._rootEle == null)
          this.LoadDomTree<CommentsEx>();
