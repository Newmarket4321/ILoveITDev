...
{
  public class NotesSlidePart : OpenXmlPart, IFixedContentTypePart
  {
    ...
    internal override sealed IDictionary<string, PartConstraintRule> GetPartConstraint()
    {
      ...
      return (IDictionary<string, PartConstraintRule>) NotesSlidePart._partConstraint;
    }
    ...
    internal override sealed IDictionary<string, PartConstraintRule> GetDataPartReferenceConstraint()
    {
      ...
      return (IDictionary<string, PartConstraintRule>) NotesSlidePart._dataPartReferenceConstraint;
    }
    ...
    internal override OpenXmlPartRootElement PartRootElement
    {
      get
      {
        return (OpenXmlPartRootElement) this.NotesSlide;
      }
    }
