...
{
  public class MacroSheetPart : OpenXmlPart, IFixedContentTypePart
  {
    ...
    internal override sealed IDictionary<string, PartConstraintRule> GetPartConstraint()
    {
      ...
      return (IDictionary<string, PartConstraintRule>) MacroSheetPart._partConstraint;
    }

    internal override sealed IDictionary<string, PartConstraintRule> GetDataPartReferenceConstraint()
    {
      if (MacroSheetPart._dataPartReferenceConstraint == null)
        MacroSheetPart._dataPartReferenceConstraint = new Dictionary<string, PartConstraintRule>();
      return (IDictionary<string, PartConstraintRule>) MacroSheetPart._dataPartReferenceConstraint;
    }
    ...
    internal override OpenXmlPartRootElement PartRootElement
    {
      get
      {
        return (OpenXmlPartRootElement) this.Macrosheet;
      }
    }
