...
// Type: DocumentFormat.OpenXml.Packaging.EndnotesPart
...
{
  public class EndnotesPart : OpenXmlPart, IFixedContentTypePart
  {
    ...
    internal override sealed IDictionary<string, PartConstraintRule> GetPartConstraint()
    {
      ...
      return (IDictionary<string, PartConstraintRule>) EndnotesPart._partConstraint;
    }
    ...
    internal override sealed IDictionary<string, PartConstraintRule> GetDataPartReferenceConstraint()
    {
      ...
      return (IDictionary<string, PartConstraintRule>) EndnotesPart._dataPartReferenceConstraint;
    }
    ...
    internal override OpenXmlPartRootElement PartRootElement
    {
      get
      {
        return (OpenXmlPartRootElement) this.Endnotes;
      }
    }
