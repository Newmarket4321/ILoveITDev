...
{
  public class SlideLayoutPart : OpenXmlPart, IFixedContentTypePart
  {
    ...
    internal override sealed IDictionary<string, PartConstraintRule> GetPartConstraint()
    {
      if (SlideLayoutPart._partConstraint == null)
        SlideLayoutPart._partConstraint = new Dictionary<string, PartConstraintRule>()
        {
          ...
          },
          {
            ...
            new PartConstraintRule("SlideMasterPart", "application/vnd.openxmlformats-officedocument.presentationml.slideMaster+xml", false, false, FileFormatVersions.Office2007 | FileFormatVersions.Office2010 | FileFormatVersions.Office2013)
          },
          {
      ...
      return (IDictionary<string, PartConstraintRule>) SlideLayoutPart._partConstraint;
    }
    ...
    internal override sealed IDictionary<string, PartConstraintRule> GetDataPartReferenceConstraint()
    {
      ...
      return (IDictionary<string, PartConstraintRule>) SlideLayoutPart._dataPartReferenceConstraint;
    }
    ...
    public SlideMasterPart SlideMasterPart
    {
      get
      {
        return this.GetSubPartOfType<SlideMasterPart>();
      }
    }
    ...
    internal override OpenXmlPartRootElement PartRootElement
    {
      get
      {
        return (OpenXmlPartRootElement) this.SlideLayout;
      }
    }
