...
namespace DocumentFormat.OpenXml.Packaging
{
  ...
  public class RibbonAndBackstageCustomizationsPart : OpenXmlPart, IFixedContentTypePart
  {
    ...
    private DocumentFormat.OpenXml.Office2010.CustomUI.CustomUI _rootEle;
    ...
    internal override sealed IDictionary<string, PartConstraintRule> GetPartConstraint()
    {
      ...
      return (IDictionary<string, PartConstraintRule>) RibbonAndBackstageCustomizationsPart._partConstraint;
    }

    internal override sealed IDictionary<string, PartConstraintRule> GetDataPartReferenceConstraint()
    {
      if (RibbonAndBackstageCustomizationsPart._dataPartReferenceConstraint == null)
        RibbonAndBackstageCustomizationsPart._dataPartReferenceConstraint = new Dictionary<string, PartConstraintRule>();
      return (IDictionary<string, PartConstraintRule>) RibbonAndBackstageCustomizationsPart._dataPartReferenceConstraint;
    }
    ...
    internal override OpenXmlPartRootElement _rootElement
    {
      ...
      set
      {
        this._rootEle = value as DocumentFormat.OpenXml.Office2010.CustomUI.CustomUI;
      }
    }
    ...
    public DocumentFormat.OpenXml.Office2010.CustomUI.CustomUI CustomUI
    {
      get
      {
        if (this._rootEle == null)
          this.LoadDomTree<DocumentFormat.OpenXml.Office2010.CustomUI.CustomUI>();
