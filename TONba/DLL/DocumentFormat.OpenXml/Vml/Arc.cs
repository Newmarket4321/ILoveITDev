...
// Type: DocumentFormat.OpenXml.Vml.Arc
...
namespace DocumentFormat.OpenXml.Vml
{
  ...
  {
    private static string[] attributeTagNames = new string[52]
    {
      "spid",
      "oned",
      "regroupid",
    ...
    public IntegerValue RegroupId
    {
      get
      {
        return (IntegerValue) this.Attributes[2];
      }
      set
      {
    ...
    public SingleValue HorizontalPercentage
    {
      get
      {
        return (SingleValue) this.Attributes[10];
      }
      set
      {
    ...
    public EnumValue<HorizontalRuleAlignmentValues> HorizontalAlignment
    {
      get
      {
        return (EnumValue<HorizontalRuleAlignmentValues>) this.Attributes[11];
      }
      set
      {
    ...
    public EnumValue<InsetMarginValues> InsetMode
    {
      get
      {
        return (EnumValue<InsetMarginValues>) this.Attributes[22];
      }
      set
      {
    ...
    public TrueFalseValue InsetPen
    {
      get
      {
        return (TrueFalseValue) this.Attributes[28];
      }
      set
      {
    ...
    public Int32Value OptionalNumber
    {
      get
      {
        return (Int32Value) this.Attributes[29];
      }
      set
      {
    ...
    public EnumValue<ConnectorValues> ConnectorType
    {
      get
      {
        return (EnumValue<ConnectorValues>) this.Attributes[30];
      }
      set
      {
    ...
    public EnumValue<BlackAndWhiteModeValues> BlackWhiteMode
    {
      get
      {
        return (EnumValue<BlackAndWhiteModeValues>) this.Attributes[31];
      }
      set
      {
    ...
    public EnumValue<BlackAndWhiteModeValues> PureBlackWhiteMode
    {
      get
      {
        return (EnumValue<BlackAndWhiteModeValues>) this.Attributes[32];
      }
      set
      {
    ...
    public EnumValue<BlackAndWhiteModeValues> NormalBlackWhiteMode
    {
      get
      {
        return (EnumValue<BlackAndWhiteModeValues>) this.Attributes[33];
      }
      set
      {
    ...
    public TrueFalseBlankValue Ole
    {
      get
      {
        return (TrueFalseBlankValue) this.Attributes[36];
      }
      set
      {
    ...
    public TrueFalseValue PreferRelative
    {
      get
      {
        return (TrueFalseValue) this.Attributes[37];
      }
      set
      {
    ...
    public StringValue Target
    {
      get
      {
        return (StringValue) this.Attributes[43];
      }
      set
      {
    ...
    public StringValue CoordinateOrigin
    {
      get
      {
        return (StringValue) this.Attributes[47];
      }
      set
      {
    ...
    public DecimalValue StartAngle
    {
      get
      {
        return (DecimalValue) this.Attributes[50];
      }
      set
      {
    ...
    public DecimalValue EndAngle
    {
      get
      {
        return (DecimalValue) this.Attributes[51];
      }
      set
      {
    ...
    internal override OpenXmlSimpleType AttributeFactory(byte namespaceId, string name)
    {
      ...
      if ((int) namespaceId == 0 && "print" == name)
        return (OpenXmlSimpleType) new TrueFalseValue();
      if ((int) namespaceId == 0 && "startangle" == name)
        return (OpenXmlSimpleType) new DecimalValue();
      if ((int) namespaceId == 0 && "endangle" == name)
        return (OpenXmlSimpleType) new DecimalValue();
