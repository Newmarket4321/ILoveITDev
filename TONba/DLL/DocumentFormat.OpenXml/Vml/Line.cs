...
// Type: DocumentFormat.OpenXml.Vml.Line
...
namespace DocumentFormat.OpenXml.Vml
{
  ...
  public class Line : OpenXmlCompositeElement
  {
    private static string[] attributeTagNames = new string[53]
    {
      "id",
      "style",
      "href",
    ...
    private static byte[] attributeNamespaceIds = new byte[53]
    {
      (byte) 0,
      (byte) 0,
      (byte) 0,
    ...
    internal override byte[] AttributeNamespaceIds
    {
      get
      {
        return Line.attributeNamespaceIds;
      }
    }
    ...
    public Line(IEnumerable<OpenXmlElement> childElements)
      : base(childElements)
    {
    }

    public Line(params OpenXmlElement[] childElements)
      : base(childElements)
    {
    }
    ...
    {
      return (OpenXmlElement) this.CloneImp<Line>(deep);
    }
  }
}
