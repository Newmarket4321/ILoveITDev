...
// Type: DocumentFormat.OpenXml.Vml.PolyLine
...
namespace DocumentFormat.OpenXml.Vml
{
  ...
  public class PolyLine : OpenXmlCompositeElement
  {
    ...
    internal override OpenXmlSimpleType AttributeFactory(byte namespaceId, string name)
    {
      ...
      if (27 == (int) namespaceId && "clip" == name)
        return (OpenXmlSimpleType) new TrueFalseValue();
      if ((int) namespaceId == 0 && "points" == name)
        return (OpenXmlSimpleType) new StringValue();
    ...
    {
      return (OpenXmlElement) this.CloneImp<PolyLine>(deep);
    }
  }
}
