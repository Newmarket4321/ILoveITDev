...
// Type: DocumentFormat.OpenXml.Vml.Shapetype
...
namespace DocumentFormat.OpenXml.Vml
{
  ...
  {
    private static string[] attributeTagNames = new string[54]
    {
      "id",
      "style",
      "href",
    ...
    private static byte[] attributeNamespaceIds = new byte[54]
    {
      (byte) 0,
      (byte) 0,
      (byte) 0,
    ...
    internal override OpenXmlSimpleType AttributeFactory(byte namespaceId, string name)
    {
      ...
      if ((int) namespaceId == 0 && "path" == name)
        return (OpenXmlSimpleType) new StringValue();
      if (27 == (int) namespaceId && "master" == name)
        return (OpenXmlSimpleType) new StringValue();
    ...
    {
      return (OpenXmlElement) this.CloneImp<Shapetype>(deep);
    }
  }
}
