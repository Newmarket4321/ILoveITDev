...
// Type: DocumentFormat.OpenXml.Vml.Shape
...
namespace DocumentFormat.OpenXml.Vml
{
  ...
  {
    private static string[] attributeTagNames = new string[56]
    {
      "id",
      "style",
      "href",
    ...
    private static byte[] attributeNamespaceIds = new byte[56]
    {
      (byte) 0,
      (byte) 0,
      (byte) 0,
    ...
    public Base64BinaryValue EncodedPackage
    {
      get
      {
        return (Base64BinaryValue) this.Attributes[54];
      }
      set
      {
    ...
    internal override OpenXmlSimpleType AttributeFactory(byte namespaceId, string name)
    {
      ...
      if ((int) namespaceId == 0 && "type" == name)
        return (OpenXmlSimpleType) new StringValue();
      if ((int) namespaceId == 0 && "adj" == name)
        return (OpenXmlSimpleType) new StringValue();
      if ((int) namespaceId == 0 && "path" == name)
        return (OpenXmlSimpleType) new StringValue();
      if (27 == (int) namespaceId && "gfxdata" == name)
        return (OpenXmlSimpleType) new Base64BinaryValue();
      if ((int) namespaceId == 0 && "equationxml" == name)
        return (OpenXmlSimpleType) new StringValue();
