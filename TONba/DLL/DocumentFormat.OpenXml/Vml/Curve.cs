...
// Type: DocumentFormat.OpenXml.Vml.Curve
...
namespace DocumentFormat.OpenXml.Vml
{
  ...
  public class Curve : OpenXmlCompositeElement
  {
    private static string[] attributeTagNames = new string[55]
    {
      "id",
      "style",
      "href",
    ...
    private static byte[] attributeNamespaceIds = new byte[55]
    {
      (byte) 0,
      (byte) 0,
      (byte) 0,
    ...
    internal override OpenXmlSimpleType AttributeFactory(byte namespaceId, string name)
    {
      ...
      if ((int) namespaceId == 0 && "from" == name)
        return (OpenXmlSimpleType) new StringValue();
      if ((int) namespaceId == 0 && "control1" == name)
        return (OpenXmlSimpleType) new StringValue();
      if ((int) namespaceId == 0 && "control2" == name)
        return (OpenXmlSimpleType) new StringValue();
    ...
    {
      return (OpenXmlElement) this.CloneImp<Curve>(deep);
    }
  }
}
