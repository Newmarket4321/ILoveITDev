...
// Type: DocumentFormat.OpenXml.NamespaceIdMap
...
namespace DocumentFormat.OpenXml
{
  ...
  {
    private static Dictionary<string, string> _namespaceTranslationDic = new Dictionary<string, string>()
    {
      {
    ...
    private static Dictionary<string, string> _relationshipTranslationDic = new Dictionary<string, string>()
    {
      {
    ...
    private static string[] _namespaceList = new string[78]
    {
      "",
    ...
    private static Dictionary<string, string> _extendedNamespaceDic = new Dictionary<string, string>()
    {
      {
    ...
    private static string[] _namespacePrefixList = new string[78]
    {
      "",
      "xml",
      "cp",
    ...
    private static HashSet<string> _O15NamespaceSet = new HashSet<string>()
    {
      "http://schemas.microsoft.com/office/drawing/2012/chart",
      "http://schemas.microsoft.com/office/drawing/2012/chartStyle",
      "http://schemas.microsoft.com/office/webextensions/webextension/2010/11",
    ...
    public static bool TryGetTransitionalNamespace(string strictNamespace, out string transitionalNamespace)
    {
      ...
      return NamespaceIdMap._namespaceTranslationDic.TryGetValue(strictNamespace, out transitionalNamespace);
    }
    ...
    public static bool TryGetTransitionalRelationship(string strictRelationship, out string transitionalRelationship)
    {
      ...
      return NamespaceIdMap._relationshipTranslationDic.TryGetValue(strictRelationship, out transitionalRelationship);
    }
    ...
    public static bool IsInFileFormat(string ns, FileFormatVersions format)
    {
      switch (format)
      {
        ...
        case FileFormatVersions.Office2013:
          return NamespaceIdMap._O15NamespaceSet.Contains(ns);
        default:
    ...
    public static byte GetNamespaceId(string namespaceUri)
    {
      ...
      if (num < 0 && NamespaceIdMap._extendedNamespaceDic.TryGetValue(namespaceUri, out namespaceUri))
        num = Array.IndexOf<string>(NamespaceIdMap._namespaceList, namespaceUri);
      if (num >= 0)
    ...
    {
      return NamespaceIdMap._extendedNamespaceDic.TryGetValue(namespaceUri, out extNamespaceUri);
    }
  }
}
