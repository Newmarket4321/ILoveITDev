...
// Type: DocumentFormat.OpenXml.CustomXmlDataProperties.SchemaReference
...
namespace DocumentFormat.OpenXml.CustomXmlDataProperties
{
  ...
  public class SchemaReference : OpenXmlLeafElement
  {
    ...
    {
      if (20 == (int) namespaceId && "uri" == name)
    ...
    {
      return (OpenXmlElement) this.CloneImp<SchemaReference>(deep);
    }
  }
}
