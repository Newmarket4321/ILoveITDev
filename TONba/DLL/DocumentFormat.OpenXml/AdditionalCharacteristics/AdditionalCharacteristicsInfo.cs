...
// Type: DocumentFormat.OpenXml.AdditionalCharacteristics.AdditionalCharacteristicsInfo
...
namespace DocumentFormat.OpenXml.AdditionalCharacteristics
{
  ...
  public class AdditionalCharacteristicsInfo : OpenXmlPartRootElement
  {
    ...
    {
      if (8 == (int) namespaceId && "characteristic" == name)
        return (OpenXmlElement) new Characteristic();
      return (OpenXmlElement) null;
    }

    public override OpenXmlElement CloneNode(bool deep)
    {
      return (OpenXmlElement) this.CloneImp<AdditionalCharacteristicsInfo>(deep);
    }
