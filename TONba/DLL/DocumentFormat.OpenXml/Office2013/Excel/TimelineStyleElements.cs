...
// Type: DocumentFormat.OpenXml.Office2013.Excel.TimelineStyleElements
...
namespace DocumentFormat.OpenXml.Office2013.Excel
{
  ...
  public class TimelineStyleElements : OpenXmlCompositeElement
  {
    ...
    public TimelineStyleElements(IEnumerable<OpenXmlElement> childElements)
      : base(childElements)
    {
    }

    public TimelineStyleElements(params OpenXmlElement[] childElements)
      : base(childElements)
    {
    }
    ...
    {
      if (71 == (int) namespaceId && "timelineStyleElement" == name)
        return (OpenXmlElement) new TimelineStyleElement();
      return (OpenXmlElement) null;
    }

    public override OpenXmlElement CloneNode(bool deep)
    {
      return (OpenXmlElement) this.CloneImp<TimelineStyleElements>(deep);
    }
  }
}
