...
// Type: DocumentFormat.OpenXml.Office2013.Drawing.Chart.FilteredSeriesTitle
...
namespace DocumentFormat.OpenXml.Office2013.Drawing.Chart
{
  ...
  public class FilteredSeriesTitle : OpenXmlCompositeElement
  {
    ...
    public FilteredSeriesTitle(IEnumerable<OpenXmlElement> childElements)
      : base(childElements)
    {
    }

    public FilteredSeriesTitle(params OpenXmlElement[] childElements)
      : base(childElements)
    {
    }
    ...
    internal override string[] ElementTagNames
    {
      get
      {
        return FilteredSeriesTitle.eleTagNames;
      }
    }
    ...
    internal override byte[] ElementNamespaceIds
    {
      get
      {
        return FilteredSeriesTitle.eleNamespaceIds;
      }
    }
    ...
    {
      return (OpenXmlElement) this.CloneImp<FilteredSeriesTitle>(deep);
    }
  }
}
