...
// Type: DocumentFormat.OpenXml.Office2013.Drawing.ChartStyle.Wall
...
namespace DocumentFormat.OpenXml.Office2013.Drawing.ChartStyle
{
  ...
  public class Wall : StyleEntry
  {
    ...
    public Wall(IEnumerable<OpenXmlElement> childElements)
      : base(childElements)
    {
    }

    public Wall(params OpenXmlElement[] childElements)
      : base(childElements)
    {
    }
    ...
    {
      return (OpenXmlElement) this.CloneImp<Wall>(deep);
    }
  }
}
