...
// Type: DocumentFormat.OpenXml.Office2013.Drawing.ChartStyle.UpBar
...
namespace DocumentFormat.OpenXml.Office2013.Drawing.ChartStyle
{
  ...
  public class UpBar : StyleEntry
  {
    ...
    public UpBar(IEnumerable<OpenXmlElement> childElements)
      : base(childElements)
    {
    }

    public UpBar(params OpenXmlElement[] childElements)
      : base(childElements)
    {
    }
    ...
    {
      return (OpenXmlElement) this.CloneImp<UpBar>(deep);
    }
  }
}
