...
// Type: DocumentFormat.OpenXml.Office2013.Drawing.ChartStyle.HiLoLine
...
namespace DocumentFormat.OpenXml.Office2013.Drawing.ChartStyle
{
  ...
  public class HiLoLine : StyleEntry
  {
    ...
    public HiLoLine(IEnumerable<OpenXmlElement> childElements)
      : base(childElements)
    {
    }

    public HiLoLine(params OpenXmlElement[] childElements)
      : base(childElements)
    {
    }
    ...
    {
      return (OpenXmlElement) this.CloneImp<HiLoLine>(deep);
    }
  }
}
