...
// Type: DocumentFormat.OpenXml.Office2013.Drawing.ChartStyle.LineWidthScale
...
namespace DocumentFormat.OpenXml.Office2013.Drawing.ChartStyle
{
  ...
  public class LineWidthScale : OpenXmlLeafTextElement
  {
    ...
    public LineWidthScale()
    {
    }

    public LineWidthScale(string text)
      : base(text)
    {
    }
    ...
    {
      return (OpenXmlElement) this.CloneImp<LineWidthScale>(deep);
    }
  }
}
