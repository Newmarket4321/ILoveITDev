...
// Type: DocumentFormat.OpenXml.Wordprocessing.Justification
...
namespace DocumentFormat.OpenXml.Wordprocessing
{
  ...
  public class Justification : OpenXmlLeafElement
  {
    ...
    public EnumValue<JustificationValues> Val
    {
      get
      {
        return (EnumValue<JustificationValues>) this.Attributes[0];
      }
      set
      {
    ...
    internal override OpenXmlSimpleType AttributeFactory(byte namespaceId, string name)
    {
      if (23 == (int) namespaceId && "val" == name)
        return (OpenXmlSimpleType) new EnumValue<JustificationValues>();
      return base.AttributeFactory(namespaceId, name);
    }

    public override OpenXmlElement CloneNode(bool deep)
    {
      return (OpenXmlElement) this.CloneImp<Justification>(deep);
    }
  }
}
