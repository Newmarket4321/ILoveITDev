...
namespace DocumentFormat.OpenXml.Wordprocessing
{
  ...
  public class StyleParagraphProperties : OpenXmlCompositeElement
  {
    ...
    public ParagraphPropertiesChange ParagraphPropertiesChange
    {
      get
      {
        return this.GetElement<ParagraphPropertiesChange>(30);
      }
      set
      {
        this.SetElement<ParagraphPropertiesChange>(30, value);
      }
    }

    public override OpenXmlElement CloneNode(bool deep)
    {
      return (OpenXmlElement) this.CloneImp<StyleParagraphProperties>(deep);
    }
  }
}
