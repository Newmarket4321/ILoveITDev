...
namespace DocumentFormat.OpenXml.Wordprocessing
{
  ...
  public class FootnotePosition : OpenXmlLeafElement
  {
    ...
    public EnumValue<FootnotePositionValues> Val
    {
      get
      {
        return (EnumValue<FootnotePositionValues>) this.Attributes[0];
      }
      set
      {
    ...
    internal override OpenXmlSimpleType AttributeFactory(byte namespaceId, string name)
    {
      if (23 == (int) namespaceId && "val" == name)
        return (OpenXmlSimpleType) new EnumValue<FootnotePositionValues>();
      return base.AttributeFactory(namespaceId, name);
    }

    public override OpenXmlElement CloneNode(bool deep)
    {
      return (OpenXmlElement) this.CloneImp<FootnotePosition>(deep);
    }
  }
}
