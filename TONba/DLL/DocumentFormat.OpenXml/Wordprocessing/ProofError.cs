...
// Type: DocumentFormat.OpenXml.Wordprocessing.ProofError
...
namespace DocumentFormat.OpenXml.Wordprocessing
{
  ...
  public class ProofError : OpenXmlLeafElement
  {
    ...
    public EnumValue<ProofingErrorValues> Type
    {
      get
      {
        return (EnumValue<ProofingErrorValues>) this.Attributes[0];
      }
      set
      {
    ...
    internal override OpenXmlSimpleType AttributeFactory(byte namespaceId, string name)
    {
      if (23 == (int) namespaceId && "type" == name)
        return (OpenXmlSimpleType) new EnumValue<ProofingErrorValues>();
      return base.AttributeFactory(namespaceId, name);
    }

    public override OpenXmlElement CloneNode(bool deep)
    {
      return (OpenXmlElement) this.CloneImp<ProofError>(deep);
    }
  }
}
