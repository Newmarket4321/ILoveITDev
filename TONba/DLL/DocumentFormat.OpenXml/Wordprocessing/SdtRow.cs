...
// Type: DocumentFormat.OpenXml.Wordprocessing.SdtRow
  ...
  public class SdtRow : SdtElement
  {
    ...
    internal override OpenXmlElement ElementFactory(byte namespaceId, string name)
    {
      ...
      if (23 == (int) namespaceId && "sdtContent" == name)
        return (OpenXmlElement) new SdtContentRow();
    ...
    public SdtContentRow SdtContentRow
    {
      get
      {
        return this.GetElement<SdtContentRow>(2);
      }
      set
      {
        this.SetElement<SdtContentRow>(2, value);
      }
    }

    public override OpenXmlElement CloneNode(bool deep)
    {
      return (OpenXmlElement) this.CloneImp<SdtRow>(deep);
    }
  }
}
