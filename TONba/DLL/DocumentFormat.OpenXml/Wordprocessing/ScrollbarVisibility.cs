...
// Type: DocumentFormat.OpenXml.Wordprocessing.ScrollbarVisibility
...
namespace DocumentFormat.OpenXml.Wordprocessing
{
  ...
  public class ScrollbarVisibility : OpenXmlLeafElement
  {
    ...
    public EnumValue<FrameScrollbarVisibilityValues> Val
    {
      get
      {
        return (EnumValue<FrameScrollbarVisibilityValues>) this.Attributes[0];
      }
      set
      {
    ...
    internal override OpenXmlSimpleType AttributeFactory(byte namespaceId, string name)
    {
      if (23 == (int) namespaceId && "val" == name)
        return (OpenXmlSimpleType) new EnumValue<FrameScrollbarVisibilityValues>();
      return base.AttributeFactory(namespaceId, name);
    }

    public override OpenXmlElement CloneNode(bool deep)
    {
      return (OpenXmlElement) this.CloneImp<ScrollbarVisibility>(deep);
    }
  }
}
