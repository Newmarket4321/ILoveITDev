...
// Type: DocumentFormat.OpenXml.Wordprocessing.SdtBlock
  ...
  public class SdtBlock : SdtElement
  {
    ...
    internal override OpenXmlElement ElementFactory(byte namespaceId, string name)
    {
      ...
      if (23 == (int) namespaceId && "sdtContent" == name)
        return (OpenXmlElement) new SdtContentBlock();
    ...
    public SdtContentBlock SdtContentBlock
    {
      get
      {
        return this.GetElement<SdtContentBlock>(2);
      }
      set
      {
        this.SetElement<SdtContentBlock>(2, value);
      }
    }

    public override OpenXmlElement CloneNode(bool deep)
    {
      return (OpenXmlElement) this.CloneImp<SdtBlock>(deep);
    }
  }
}
