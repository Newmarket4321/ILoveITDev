...
// Type: DocumentFormat.OpenXml.Wordprocessing.Destination
...
namespace DocumentFormat.OpenXml.Wordprocessing
{
  ...
  public class Destination : OpenXmlLeafElement
  {
    ...
    public EnumValue<MailMergeDestinationValues> Val
    {
      get
      {
        return (EnumValue<MailMergeDestinationValues>) this.Attributes[0];
      }
      set
      {
    ...
    internal override OpenXmlSimpleType AttributeFactory(byte namespaceId, string name)
    {
      if (23 == (int) namespaceId && "val" == name)
        return (OpenXmlSimpleType) new EnumValue<MailMergeDestinationValues>();
      return base.AttributeFactory(namespaceId, name);
    }

    public override OpenXmlElement CloneNode(bool deep)
    {
      return (OpenXmlElement) this.CloneImp<Destination>(deep);
    }
  }
}
