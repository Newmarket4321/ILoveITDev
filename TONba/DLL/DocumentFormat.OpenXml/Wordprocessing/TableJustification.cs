...
// Type: DocumentFormat.OpenXml.Wordprocessing.TableJustification
...
namespace DocumentFormat.OpenXml.Wordprocessing
{
  ...
  public class TableJustification : OpenXmlLeafElement
  {
    ...
    public EnumValue<TableRowAlignmentValues> Val
    {
      get
      {
        return (EnumValue<TableRowAlignmentValues>) this.Attributes[0];
      }
      set
      {
    ...
    internal override OpenXmlSimpleType AttributeFactory(byte namespaceId, string name)
    {
      if (23 == (int) namespaceId && "val" == name)
        return (OpenXmlSimpleType) new EnumValue<TableRowAlignmentValues>();
      return base.AttributeFactory(namespaceId, name);
    }

    public override OpenXmlElement CloneNode(bool deep)
    {
      return (OpenXmlElement) this.CloneImp<TableJustification>(deep);
    }
  }
}
