...
// Type: DocumentFormat.OpenXml.Wordprocessing.HeaderFooterType
...
namespace DocumentFormat.OpenXml.Wordprocessing
{
  ...
  public abstract class HeaderFooterType : OpenXmlCompositeElement
  {
    ...
    protected HeaderFooterType(IEnumerable<OpenXmlElement> childElements)
      : base(childElements)
    {
    }

    protected HeaderFooterType(params OpenXmlElement[] childElements)
      : base(childElements)
    {
    }
