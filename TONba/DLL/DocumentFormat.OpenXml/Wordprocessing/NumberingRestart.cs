...
// Type: DocumentFormat.OpenXml.Wordprocessing.NumberingRestart
...
namespace DocumentFormat.OpenXml.Wordprocessing
{
  ...
  public class NumberingRestart : OpenXmlLeafElement
  {
    ...
    public EnumValue<RestartNumberValues> Val
    {
      get
      {
        return (EnumValue<RestartNumberValues>) this.Attributes[0];
      }
      set
      {
    ...
    internal override OpenXmlSimpleType AttributeFactory(byte namespaceId, string name)
    {
      if (23 == (int) namespaceId && "val" == name)
        return (OpenXmlSimpleType) new EnumValue<RestartNumberValues>();
      return base.AttributeFactory(namespaceId, name);
    }

    public override OpenXmlElement CloneNode(bool deep)
    {
      return (OpenXmlElement) this.CloneImp<NumberingRestart>(deep);
    }
  }
}
