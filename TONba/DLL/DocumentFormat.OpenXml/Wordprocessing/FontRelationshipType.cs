...
// Type: DocumentFormat.OpenXml.Wordprocessing.FontRelationshipType
...
namespace DocumentFormat.OpenXml.Wordprocessing
{
  ...
  public abstract class FontRelationshipType : OpenXmlLeafElement
  {
    ...
    {
      if (23 == (int) namespaceId && "fontKey" == name)
        return (OpenXmlSimpleType) new StringValue();
      if (23 == (int) namespaceId && "subsetted" == name)
