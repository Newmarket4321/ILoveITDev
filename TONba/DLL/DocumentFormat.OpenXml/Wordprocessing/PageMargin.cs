...
namespace DocumentFormat.OpenXml.Wordprocessing
{
  ...
  public class PageMargin : OpenXmlLeafElement
  {
    ...
    internal override OpenXmlSimpleType AttributeFactory(byte namespaceId, string name)
    {
      ...
      if (23 == (int) namespaceId && "left" == name)
        return (OpenXmlSimpleType) new UInt32Value();
      if (23 == (int) namespaceId && "header" == name)
        return (OpenXmlSimpleType) new UInt32Value();
      if (23 == (int) namespaceId && "footer" == name)
        return (OpenXmlSimpleType) new UInt32Value();
      if (23 == (int) namespaceId && "gutter" == name)
        return (OpenXmlSimpleType) new UInt32Value();
    ...
    {
      return (OpenXmlElement) this.CloneImp<PageMargin>(deep);
    }
  }
}
