...
namespace DocumentFormat.OpenXml.Wordprocessing
{
  ...
  public class MainDocumentType : OpenXmlLeafElement
  {
    ...
    public EnumValue<MailMergeDocumentValues> Val
    {
      get
      {
        return (EnumValue<MailMergeDocumentValues>) this.Attributes[0];
      }
      set
      {
    ...
    internal override OpenXmlSimpleType AttributeFactory(byte namespaceId, string name)
    {
      if (23 == (int) namespaceId && "val" == name)
        return (OpenXmlSimpleType) new EnumValue<MailMergeDocumentValues>();
      return base.AttributeFactory(namespaceId, name);
    }

    public override OpenXmlElement CloneNode(bool deep)
    {
      return (OpenXmlElement) this.CloneImp<MainDocumentType>(deep);
    }
  }
}
