...
namespace DocumentFormat.OpenXml.Wordprocessing
{
  ...
  public class TableCellVerticalAlignment : OpenXmlLeafElement
  {
    ...
    public EnumValue<TableVerticalAlignmentValues> Val
    {
      get
      {
        return (EnumValue<TableVerticalAlignmentValues>) this.Attributes[0];
      }
      set
      {
    ...
    internal override OpenXmlSimpleType AttributeFactory(byte namespaceId, string name)
    {
      if (23 == (int) namespaceId && "val" == name)
        return (OpenXmlSimpleType) new EnumValue<TableVerticalAlignmentValues>();
      return base.AttributeFactory(namespaceId, name);
    }

    public override OpenXmlElement CloneNode(bool deep)
    {
      return (OpenXmlElement) this.CloneImp<TableCellVerticalAlignment>(deep);
    }
  }
}
