...
// Type: DocumentFormat.OpenXml.Wordprocessing.TableOverlap
...
namespace DocumentFormat.OpenXml.Wordprocessing
{
  ...
  public class TableOverlap : OpenXmlLeafElement
  {
    ...
    public EnumValue<TableOverlapValues> Val
    {
      get
      {
        return (EnumValue<TableOverlapValues>) this.Attributes[0];
      }
      set
      {
    ...
    internal override OpenXmlSimpleType AttributeFactory(byte namespaceId, string name)
    {
      if (23 == (int) namespaceId && "val" == name)
        return (OpenXmlSimpleType) new EnumValue<TableOverlapValues>();
      return base.AttributeFactory(namespaceId, name);
    }

    public override OpenXmlElement CloneNode(bool deep)
    {
      return (OpenXmlElement) this.CloneImp<TableOverlap>(deep);
    }
  }
}
