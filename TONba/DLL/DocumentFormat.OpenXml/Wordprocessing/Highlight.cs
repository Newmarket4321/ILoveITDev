...
// Type: DocumentFormat.OpenXml.Wordprocessing.Highlight
...
namespace DocumentFormat.OpenXml.Wordprocessing
{
  ...
  public class Highlight : OpenXmlLeafElement
  {
    ...
    public EnumValue<HighlightColorValues> Val
    {
      get
      {
        return (EnumValue<HighlightColorValues>) this.Attributes[0];
      }
      set
      {
    ...
    internal override OpenXmlSimpleType AttributeFactory(byte namespaceId, string name)
    {
      if (23 == (int) namespaceId && "val" == name)
        return (OpenXmlSimpleType) new EnumValue<HighlightColorValues>();
      return base.AttributeFactory(namespaceId, name);
    }

    public override OpenXmlElement CloneNode(bool deep)
    {
      return (OpenXmlElement) this.CloneImp<Highlight>(deep);
    }
  }
}
