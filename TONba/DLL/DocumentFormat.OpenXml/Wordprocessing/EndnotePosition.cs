...
namespace DocumentFormat.OpenXml.Wordprocessing
{
  ...
  public class EndnotePosition : OpenXmlLeafElement
  {
    ...
    public EnumValue<EndnotePositionValues> Val
    {
      get
      {
        return (EnumValue<EndnotePositionValues>) this.Attributes[0];
      }
      set
      {
    ...
    internal override OpenXmlSimpleType AttributeFactory(byte namespaceId, string name)
    {
      if (23 == (int) namespaceId && "val" == name)
        return (OpenXmlSimpleType) new EnumValue<EndnotePositionValues>();
      return base.AttributeFactory(namespaceId, name);
    }

    public override OpenXmlElement CloneNode(bool deep)
    {
      return (OpenXmlElement) this.CloneImp<EndnotePosition>(deep);
    }
  }
}
