...
// Type: DocumentFormat.OpenXml.Wordprocessing.TextDirection
...
namespace DocumentFormat.OpenXml.Wordprocessing
{
  ...
  public class TextDirection : OpenXmlLeafElement
  {
    ...
    public EnumValue<TextDirectionValues> Val
    {
      get
      {
        return (EnumValue<TextDirectionValues>) this.Attributes[0];
      }
      set
      {
    ...
    internal override OpenXmlSimpleType AttributeFactory(byte namespaceId, string name)
    {
      if (23 == (int) namespaceId && "val" == name)
        return (OpenXmlSimpleType) new EnumValue<TextDirectionValues>();
      return base.AttributeFactory(namespaceId, name);
    }

    public override OpenXmlElement CloneNode(bool deep)
    {
      return (OpenXmlElement) this.CloneImp<TextDirection>(deep);
    }
  }
}
