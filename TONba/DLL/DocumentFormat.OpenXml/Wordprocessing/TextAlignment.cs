...
// Type: DocumentFormat.OpenXml.Wordprocessing.TextAlignment
...
namespace DocumentFormat.OpenXml.Wordprocessing
{
  ...
  public class TextAlignment : OpenXmlLeafElement
  {
    ...
    public EnumValue<VerticalTextAlignmentValues> Val
    {
      get
      {
        return (EnumValue<VerticalTextAlignmentValues>) this.Attributes[0];
      }
      set
      {
    ...
    internal override OpenXmlSimpleType AttributeFactory(byte namespaceId, string name)
    {
      if (23 == (int) namespaceId && "val" == name)
        return (OpenXmlSimpleType) new EnumValue<VerticalTextAlignmentValues>();
      return base.AttributeFactory(namespaceId, name);
    }

    public override OpenXmlElement CloneNode(bool deep)
    {
      return (OpenXmlElement) this.CloneImp<TextAlignment>(deep);
    }
  }
}
