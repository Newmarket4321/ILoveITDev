...
// Type: DocumentFormat.OpenXml.Wordprocessing.TextBoxFormFieldType
...
namespace DocumentFormat.OpenXml.Wordprocessing
{
  ...
  public class TextBoxFormFieldType : OpenXmlLeafElement
  {
    ...
    public EnumValue<TextBoxFormFieldValues> Val
    {
      get
      {
        return (EnumValue<TextBoxFormFieldValues>) this.Attributes[0];
      }
      set
      {
    ...
    internal override OpenXmlSimpleType AttributeFactory(byte namespaceId, string name)
    {
      if (23 == (int) namespaceId && "val" == name)
        return (OpenXmlSimpleType) new EnumValue<TextBoxFormFieldValues>();
      return base.AttributeFactory(namespaceId, name);
    }

    public override OpenXmlElement CloneNode(bool deep)
    {
      return (OpenXmlElement) this.CloneImp<TextBoxFormFieldType>(deep);
    }
  }
}
