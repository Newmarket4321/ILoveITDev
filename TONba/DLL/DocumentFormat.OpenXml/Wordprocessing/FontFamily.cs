...
// Type: DocumentFormat.OpenXml.Wordprocessing.FontFamily
...
namespace DocumentFormat.OpenXml.Wordprocessing
{
  ...
  public class FontFamily : OpenXmlLeafElement
  {
    ...
    public EnumValue<FontFamilyValues> Val
    {
      get
      {
        return (EnumValue<FontFamilyValues>) this.Attributes[0];
      }
      set
      {
    ...
    internal override OpenXmlSimpleType AttributeFactory(byte namespaceId, string name)
    {
      if (23 == (int) namespaceId && "val" == name)
        return (OpenXmlSimpleType) new EnumValue<FontFamilyValues>();
