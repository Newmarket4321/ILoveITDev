...
namespace DocumentFormat.OpenXml.Wordprocessing
{
  ...
  public class FontCharSet : OpenXmlLeafElement
  {
    ...
    public EnumValue<DocumentFormat.OpenXml.Wordprocessing.StrictCharacterSet> StrictCharacterSet
    {
      get
      {
        return (EnumValue<DocumentFormat.OpenXml.Wordprocessing.StrictCharacterSet>) this.Attributes[1];
      }
      set
      {
    ...
    internal override OpenXmlSimpleType AttributeFactory(byte namespaceId, string name)
    {
      ...
      if (23 == (int) namespaceId && "characterSet" == name)
        return (OpenXmlSimpleType) new EnumValue<DocumentFormat.OpenXml.Wordprocessing.StrictCharacterSet>();
      return base.AttributeFactory(namespaceId, name);
    }

    public override OpenXmlElement CloneNode(bool deep)
    {
      return (OpenXmlElement) this.CloneImp<FontCharSet>(deep);
    }
  }
}
