...
// Type: DocumentFormat.OpenXml.Wordprocessing.Behavior
...
namespace DocumentFormat.OpenXml.Wordprocessing
{
  ...
  public class Behavior : OpenXmlLeafElement
  {
    ...
    public EnumValue<DocPartBehaviorValues> Val
    {
      get
      {
        return (EnumValue<DocPartBehaviorValues>) this.Attributes[0];
      }
      set
      {
    ...
    internal override OpenXmlSimpleType AttributeFactory(byte namespaceId, string name)
    {
      if (23 == (int) namespaceId && "val" == name)
        return (OpenXmlSimpleType) new EnumValue<DocPartBehaviorValues>();
      return base.AttributeFactory(namespaceId, name);
    }

    public override OpenXmlElement CloneNode(bool deep)
    {
      return (OpenXmlElement) this.CloneImp<Behavior>(deep);
    }
  }
}
