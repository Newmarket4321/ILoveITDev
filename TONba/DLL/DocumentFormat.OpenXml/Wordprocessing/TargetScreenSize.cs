...
// Type: DocumentFormat.OpenXml.Wordprocessing.TargetScreenSize
...
namespace DocumentFormat.OpenXml.Wordprocessing
{
  ...
  public class TargetScreenSize : OpenXmlLeafElement
  {
    ...
    public EnumValue<TargetScreenSizeValues> Val
    {
      get
      {
        return (EnumValue<TargetScreenSizeValues>) this.Attributes[0];
      }
      set
      {
    ...
    {
      return (OpenXmlElement) this.CloneImp<TargetScreenSize>(deep);
    }
  }
}
