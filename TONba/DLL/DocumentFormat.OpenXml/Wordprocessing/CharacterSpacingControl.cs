...
// Type: DocumentFormat.OpenXml.Wordprocessing.CharacterSpacingControl
...
namespace DocumentFormat.OpenXml.Wordprocessing
{
  ...
  public class CharacterSpacingControl : OpenXmlLeafElement
  {
    ...
    public EnumValue<CharacterSpacingValues> Val
    {
      get
      {
        return (EnumValue<CharacterSpacingValues>) this.Attributes[0];
      }
      set
      {
    ...
    internal override OpenXmlSimpleType AttributeFactory(byte namespaceId, string name)
    {
      if (23 == (int) namespaceId && "val" == name)
        return (OpenXmlSimpleType) new EnumValue<CharacterSpacingValues>();
      return base.AttributeFactory(namespaceId, name);
    }

    public override OpenXmlElement CloneNode(bool deep)
    {
      return (OpenXmlElement) this.CloneImp<CharacterSpacingControl>(deep);
    }
  }
}
