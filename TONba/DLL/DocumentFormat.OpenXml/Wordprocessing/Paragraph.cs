...
// Type: DocumentFormat.OpenXml.Wordprocessing.Paragraph
  ...
  public class Paragraph : OpenXmlCompositeElement
  {
    ...
    internal override OpenXmlSimpleType AttributeFactory(byte namespaceId, string name)
    {
      ...
      if (23 == (int) namespaceId && "rsidDel" == name)
        return (OpenXmlSimpleType) new HexBinaryValue();
      if (23 == (int) namespaceId && "rsidP" == name)
        return (OpenXmlSimpleType) new HexBinaryValue();
      if (23 == (int) namespaceId && "rsidRDefault" == name)
        return (OpenXmlSimpleType) new HexBinaryValue();
      if (52 == (int) namespaceId && "paraId" == name)
        return (OpenXmlSimpleType) new HexBinaryValue();
      if (52 == (int) namespaceId && "textId" == name)
        return (OpenXmlSimpleType) new HexBinaryValue();
      if (52 == (int) namespaceId && "noSpellErr" == name)
