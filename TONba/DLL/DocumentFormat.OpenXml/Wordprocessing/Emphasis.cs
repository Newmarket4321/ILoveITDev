...
// Type: DocumentFormat.OpenXml.Wordprocessing.Emphasis
...
namespace DocumentFormat.OpenXml.Wordprocessing
{
  ...
  public class Emphasis : OpenXmlLeafElement
  {
    ...
    public EnumValue<EmphasisMarkValues> Val
    {
      get
      {
        return (EnumValue<EmphasisMarkValues>) this.Attributes[0];
      }
      set
      {
    ...
    internal override OpenXmlSimpleType AttributeFactory(byte namespaceId, string name)
    {
      if (23 == (int) namespaceId && "val" == name)
        return (OpenXmlSimpleType) new EnumValue<EmphasisMarkValues>();
      return base.AttributeFactory(namespaceId, name);
    }

    public override OpenXmlElement CloneNode(bool deep)
    {
      return (OpenXmlElement) this.CloneImp<Emphasis>(deep);
    }
  }
}
