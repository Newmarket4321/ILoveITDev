...
// Type: DocumentFormat.OpenXml.Wordprocessing.SimpleFieldRuby
...
namespace DocumentFormat.OpenXml.Wordprocessing
{
  ...
  public class SimpleFieldRuby : OpenXmlCompositeElement
  {
    ...
    {
      if (23 == (int) namespaceId && "instr" == name)
    ...
    {
      return (OpenXmlElement) this.CloneImp<SimpleFieldRuby>(deep);
    }
  }
}
