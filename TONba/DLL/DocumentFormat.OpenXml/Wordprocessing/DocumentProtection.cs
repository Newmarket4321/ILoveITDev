...
// Type: DocumentFormat.OpenXml.Wordprocessing.DocumentProtection
...
namespace DocumentFormat.OpenXml.Wordprocessing
{
  ...
  public class DocumentProtection : OpenXmlLeafElement
  {
    ...
    public EnumValue<DocumentProtectionValues> Edit
    {
      get
      {
        return (EnumValue<DocumentProtectionValues>) this.Attributes[0];
      }
      set
      {
    ...
    public EnumValue<CryptProviderValues> CryptographicProviderType
    {
      get
      {
        return (EnumValue<CryptProviderValues>) this.Attributes[3];
      }
      set
      {
    ...
    public EnumValue<CryptAlgorithmClassValues> CryptographicAlgorithmClass
    {
      get
      {
        return (EnumValue<CryptAlgorithmClassValues>) this.Attributes[4];
      }
      set
      {
    ...
    public EnumValue<CryptAlgorithmValues> CryptographicAlgorithmType
    {
      get
      {
        return (EnumValue<CryptAlgorithmValues>) this.Attributes[5];
      }
      set
      {
    ...
    public Base64BinaryValue HashValue
    {
      get
      {
        return (Base64BinaryValue) this.Attributes[16];
      }
      set
      {
    ...
    public Base64BinaryValue SaltValue
    {
      get
      {
        return (Base64BinaryValue) this.Attributes[17];
      }
      set
      {
    ...
    {
      if (23 == (int) namespaceId && "edit" == name)
        return (OpenXmlSimpleType) new EnumValue<DocumentProtectionValues>();
      if (23 == (int) namespaceId && "formatting" == name)
        return (OpenXmlSimpleType) new OnOffValue();
      if (23 == (int) namespaceId && "enforcement" == name)
        return (OpenXmlSimpleType) new OnOffValue();
    ...
    {
      return (OpenXmlElement) this.CloneImp<DocumentProtection>(deep);
    }
  }
}
