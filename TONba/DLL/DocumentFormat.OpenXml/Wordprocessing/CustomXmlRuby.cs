...
// Type: DocumentFormat.OpenXml.Wordprocessing.CustomXmlRuby
...
namespace DocumentFormat.OpenXml.Wordprocessing
{
  ...
  public class CustomXmlRuby : CustomXmlElement
  {
    ...
    {
      return (OpenXmlElement) this.CloneImp<CustomXmlRuby>(deep);
    }
  }
}
