...
namespace DocumentFormat.OpenXml.Wordprocessing
{
  ...
  public class SdtDateMappingType : OpenXmlLeafElement
  {
    ...
    public EnumValue<DateFormatValues> Val
    {
      get
      {
        return (EnumValue<DateFormatValues>) this.Attributes[0];
      }
      set
      {
    ...
    internal override OpenXmlSimpleType AttributeFactory(byte namespaceId, string name)
    {
      if (23 == (int) namespaceId && "val" == name)
        return (OpenXmlSimpleType) new EnumValue<DateFormatValues>();
      return base.AttributeFactory(namespaceId, name);
    }

    public override OpenXmlElement CloneNode(bool deep)
    {
      return (OpenXmlElement) this.CloneImp<SdtDateMappingType>(deep);
    }
  }
}
