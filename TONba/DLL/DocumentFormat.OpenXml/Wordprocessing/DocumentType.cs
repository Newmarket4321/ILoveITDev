...
// Type: DocumentFormat.OpenXml.Wordprocessing.DocumentType
...
namespace DocumentFormat.OpenXml.Wordprocessing
{
  ...
  public class DocumentType : OpenXmlLeafElement
  {
    ...
    public EnumValue<DocumentTypeValues> Val
    {
      get
      {
        return (EnumValue<DocumentTypeValues>) this.Attributes[0];
      }
      set
      {
    ...
    internal override OpenXmlSimpleType AttributeFactory(byte namespaceId, string name)
    {
      if (23 == (int) namespaceId && "val" == name)
        return (OpenXmlSimpleType) new EnumValue<DocumentTypeValues>();
      return base.AttributeFactory(namespaceId, name);
    }

    public override OpenXmlElement CloneNode(bool deep)
    {
      return (OpenXmlElement) this.CloneImp<DocumentType>(deep);
    }
  }
}
