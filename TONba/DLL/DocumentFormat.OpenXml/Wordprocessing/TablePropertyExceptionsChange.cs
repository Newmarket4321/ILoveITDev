  ...
  public class TablePropertyExceptionsChange : OpenXmlCompositeElement
  {
    ...
    internal override OpenXmlElement ElementFactory(byte namespaceId, string name)
    {
      if (23 == (int) namespaceId && "tblPrEx" == name)
        return (OpenXmlElement) new PreviousTablePropertyExceptions();
    ...
    public PreviousTablePropertyExceptions PreviousTablePropertyExceptions
    {
      get
      {
        return this.GetElement<PreviousTablePropertyExceptions>(0);
      }
      set
      {
        this.SetElement<PreviousTablePropertyExceptions>(0, value);
      }
    }
    ...
    {
      return (OpenXmlElement) this.CloneImp<TablePropertyExceptionsChange>(deep);
    }
  }
}
