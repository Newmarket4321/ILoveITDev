...
// Type: DocumentFormat.OpenXml.Wordprocessing.MailMergeFieldType
...
namespace DocumentFormat.OpenXml.Wordprocessing
{
  ...
  public class MailMergeFieldType : OpenXmlLeafElement
  {
    ...
    public EnumValue<MailMergeOdsoFieldValues> Val
    {
      get
      {
        return (EnumValue<MailMergeOdsoFieldValues>) this.Attributes[0];
      }
      set
      {
    ...
    internal override OpenXmlSimpleType AttributeFactory(byte namespaceId, string name)
    {
      if (23 == (int) namespaceId && "val" == name)
        return (OpenXmlSimpleType) new EnumValue<MailMergeOdsoFieldValues>();
      return base.AttributeFactory(namespaceId, name);
    }

    public override OpenXmlElement CloneNode(bool deep)
    {
      return (OpenXmlElement) this.CloneImp<MailMergeFieldType>(deep);
    }
  }
}
