  ...
  public class ParagraphProperties : OpenXmlCompositeElement
  {
    ...
    internal override OpenXmlElement ElementFactory(byte namespaceId, string name)
    {
      ...
      if (23 == (int) namespaceId && "rPr" == name)
        return (OpenXmlElement) new ParagraphMarkRunProperties();
      if (23 == (int) namespaceId && "sectPr" == name)
        return (OpenXmlElement) new SectionProperties();
      if (23 == (int) namespaceId && "pPrChange" == name)
        return (OpenXmlElement) new ParagraphPropertiesChange();
    ...
    public DivId DivId
    {
      get
      {
        return this.GetElement<DivId>(31);
      }
      set
      {
        this.SetElement<DivId>(31, value);
      }
    }
    ...
    public ConditionalFormatStyle ConditionalFormatStyle
    {
      get
      {
        return this.GetElement<ConditionalFormatStyle>(32);
      }
      set
      {
        this.SetElement<ConditionalFormatStyle>(32, value);
      }
    }
    ...
    public ParagraphMarkRunProperties ParagraphMarkRunProperties
    {
      get
      {
        return this.GetElement<ParagraphMarkRunProperties>(33);
      }
      set
      {
        this.SetElement<ParagraphMarkRunProperties>(33, value);
      }
    }
    ...
    public SectionProperties SectionProperties
    {
      get
      {
        return this.GetElement<SectionProperties>(34);
      }
      set
      {
        this.SetElement<SectionProperties>(34, value);
      }
    }
    ...
    public ParagraphPropertiesChange ParagraphPropertiesChange
    {
      get
      {
        return this.GetElement<ParagraphPropertiesChange>(35);
      }
      set
      {
        this.SetElement<ParagraphPropertiesChange>(35, value);
      }
    }

    public override OpenXmlElement CloneNode(bool deep)
    {
      return (OpenXmlElement) this.CloneImp<ParagraphProperties>(deep);
    }
  }
}
