...
// Type: DocumentFormat.OpenXml.Wordprocessing.SdtRun
...
namespace DocumentFormat.OpenXml.Wordprocessing
{
  ...
  public class SdtRun : SdtElement
  {
    ...
    internal override OpenXmlElement ElementFactory(byte namespaceId, string name)
    {
      ...
      if (23 == (int) namespaceId && "sdtContent" == name)
        return (OpenXmlElement) new SdtContentRun();
    ...
    public SdtContentRun SdtContentRun
    {
      get
      {
        return this.GetElement<SdtContentRun>(2);
      }
      set
      {
        this.SetElement<SdtContentRun>(2, value);
      }
    }

    public override OpenXmlElement CloneNode(bool deep)
    {
      return (OpenXmlElement) this.CloneImp<SdtRun>(deep);
    }
  }
}
