...
// Type: DocumentFormat.OpenXml.Wordprocessing.DocPartType
...
namespace DocumentFormat.OpenXml.Wordprocessing
{
  ...
  public class DocPartType : OpenXmlLeafElement
  {
    ...
    public EnumValue<DocPartValues> Val
    {
      get
      {
        return (EnumValue<DocPartValues>) this.Attributes[0];
      }
      set
      {
    ...
    internal override OpenXmlSimpleType AttributeFactory(byte namespaceId, string name)
    {
      if (23 == (int) namespaceId && "val" == name)
        return (OpenXmlSimpleType) new EnumValue<DocPartValues>();
      return base.AttributeFactory(namespaceId, name);
    }

    public override OpenXmlElement CloneNode(bool deep)
    {
      return (OpenXmlElement) this.CloneImp<DocPartType>(deep);
    }
  }
}
