...
namespace I_IT
{
    public partial class MortgageReportTXM : Form
    {
        public MortgageReportTXM()
        {
            InitializeComponent();
        }

        private void MortgageReportTXM_Load(object sender, EventArgs e)
        {
            Hide();

            bool success;
            DateTime start = Core.getDate("From date", out success);
            ...
            DateTime end = Core.getDate("To date", out success);
